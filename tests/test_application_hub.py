...
from kai.application_hub import ApplicationHub, Application 
...
class TestReports(unittest.TestCase):
    ...
    def test_find_common_violation(self):
        ...
        with open("debug_find_common_violations.json", 'w') as fout:
            fout.write(f"hub.find_common_violation({ruleset_example_1}, {violation_example_1})\n")
