(() => {
  ...
  function o(e) {
    return (
      e instanceof a || (e instanceof Error && e.name === i && e.message === i)
    );
  }
  ...
  let h = null;
  function u(e) {
    return null === h || void 0 === h || h.trackDisposable(e), e;
  }
  function d(e) {
    null === h || void 0 === h || h.markAsDisposed(e);
  }
  function f(e, t) {
    null === h || void 0 === h || h.setParent(e, t);
  }
  ...
  function b() {
    ...
    return (
      (function (e, t) {
        if (h) for (const n of e) h.setParent(n, t);
      })(t, r),
      r
    );
  }
  ...
  p.DISABLE_DISPOSED_WARNING = !1;
  class w {
    constructor() {
      (this._store = new p()), u(this), f(this._store, this);
    }
    dispose() {
  ...
  class S {
    ...
    clear() {
      ...
      for (; e !== y.Undefined; ) {
        const t = e.next;
        (e.prev = y.Undefined), (e.next = y.Undefined), (e = t);
      }
      (this._first = y.Undefined), (this._last = y.Undefined), (this._size = 0);
    }
    unshift(e) {
    ...
    _insert(e, t) {
      const n = new y(e);
      if (this._first === y.Undefined) (this._first = n), (this._last = n);
      else if (t) {
        const e = this._last;
  ...
  let k,
    ...
    B = null;
  const U =
    "object" === typeof self ? self : "object" === typeof e.g ? e.g : {};
  let q;
  "undefined" !== typeof U.vscode && "undefined" !== typeof U.vscode.process
    ? (q = U.vscode.process)
    : "undefined" !== typeof process && (q = process);
  const H =
      "string" ===
      typeof (null === (E = null === q || void 0 === q ? void 0 : q.versions) ||
      void 0 === E
        ? void 0
        : E.electron),
    W = H && "renderer" === (null === q || void 0 === q ? void 0 : q.type);
  if ("object" !== typeof navigator || W)
    if ("object" === typeof q) {
      (M = "win32" === q.platform),
        (O = "darwin" === q.platform),
        (T = "linux" === q.platform),
        (x = T && !!q.env.SNAP && !!q.env.SNAP_REVISION),
        (K = H),
        (V = !!q.env.CI || !!q.env.BUILD_ARTIFACTSTAGINGDIRECTORY),
        (k = A),
        (F = A);
      ...
      if (e)
        try {
          ...
          (k = t.locale), (F = n || A), (B = t._translationsConfigFile);
        } catch (kr) {}
      P = !0;
    } else console.error("Unable to resolve platform.");
  else {
    (R = navigator.userAgent),
      (M = R.indexOf("Windows") >= 0),
  ...
  const j = M,
    G = O,
    Y = (I && U.importScripts, R),
    Z = "function" === typeof U.postMessage && !U.importScripts;
  (() => {
    if (Z) {
      const e = [];
  ...
  const J = !!(Y && Y.indexOf("Chrome") >= 0),
    Q =
      (Y && Y.indexOf("Firefox"),
      !J && Y && Y.indexOf("Safari"),
      Y && Y.indexOf("Edg/"),
      Y && Y.indexOf("Android"),
      U.performance && "function" === typeof U.performance.now);
  class X {
    constructor(e) {
      (this._highResolution = Q && e),
  ...
  !(function (e) {
    ...
    function n(e) {
      return function (t) {
        ...
        return (
          (n = e(
            (e) => {
              if (!i) return n ? n.dispose() : (i = !0), t.call(r, e);
            },
            null,
    ...
    function s(e, n) {
      ...
      n || t();
      const o = new re(i);
      return null === n || void 0 === n || n.add(o), o.event;
    }
    function l(e, n) {
      let r,
        i,
        ...
        c = 0;
      const h = {
        leakWarningThreshold: arguments.length > 4 ? arguments[4] : void 0,
        onFirstListenerAdd() {
          r = e((e) => {
            c++,
              (i = n(i, e)),
              s && !o && (u.fire(i), (i = void 0)),
              clearTimeout(o),
              (o = setTimeout(() => {
                const e = i;
                (i = void 0), (o = void 0), (!s || c > 1) && u.fire(e), (c = 0);
              }, a));
          });
        },
        onLastListenerRemove() {
      ...
      l || t();
      const u = new re(h);
      return null === l || void 0 === l || l.add(u), u.event;
    }
    function c(e) {
      let t,
        n =
    ...
    (e.None = () => w.None),
      ...
      (e.any = function () {
        ...
        return function (e) {
          ...
          return b(...t.map((t) => t((t) => e.call(n, t), null, r)));
        };
      }),
      (e.reduce = a),
      (e.debounce = l),
      ...
      (e.buffer = function (e) {
        ...
        const i = () => {
            null === n || void 0 === n || n.forEach((e) => o.fire(e)),
              (n = null);
          },
          o = new re({
            onFirstListenerAdd() {
    ...
    class h {
      constructor(e) {
        (this.event = e), (this.disposables = new p());
      }
      map(e) {
    ...
    (e.chain = function (e) {
      ...
      (e.runAndSubscribeWithStore = function (e, t) {
        let n = null;
        function r(e) {
          null === n || void 0 === n || n.dispose(), (n = new p()), t(e, n);
        }
        r(void 0);
        const i = e((e) => r(e));
        return C(() => {
    ...
    class u {
      constructor(e, n) {
        ...
        n || t(), (this.emitter = new re(r)), n && n.add(this.emitter);
      }
      beginUpdate(e) {
        this._counter++;
      }
  ...
  class ee {
    constructor(e) {
      (this._listenerCount = 0),
        ...
        (this._name = "".concat(e, "_").concat(ee._idPool++));
    }
    start(e) {
  ...
  class te {
    ...
    static create() {
      var e;
      return new te(null !== (e = new Error().stack) && void 0 !== e ? e : "");
    }
    print() {
          ...
          (this._event = (e, t, n) => {
            ...
            const u = c.subscription.set(() => {
              if (
                (null === s || void 0 === s || s(),
                !this._disposed &&
                  (h(), this._options && this._options.onLastListenerRemove))
              ) {
                (this._listeners && !this._listeners.isEmpty()) ||
                  this._options.onLastListenerRemove(this);
              }
            });
            return n instanceof p ? n.add(u) : Array.isArray(n) && n.push(u), u;
          }),
        this._event
      );
    }
  ...
  (he = we),
    (we.ambiguousCharacterData = new ce(() =>
      JSON.parse(
    ...
    (we._locales = new ce(() =>
      Object.keys(we.ambiguousCharacterData.getValue()).filter(
        (e) => !e.startsWith("_"),
      ),
    ));
  class _e {
    ...
    sendMessage(e, t) {
      ...
      return new Promise((r, i) => {
        (this._pendingReplies[n] = { resolve: r, reject: i }),
          this._send(new ve(this._workerId, n, e, t));
      });
    }
    listen(e, t) {
      let n = null;
      const r = new re({
        ...
        onLastListenerRemove: () => {
          this._pendingEmitters.delete(n),
            this._send(new Ae(this._workerId, n)),
            (n = null);
        },
      });
      return r.event;
      ...
      this._handler.handleMessage(e.method, e.args).then(
        ...
        (e) => {
          e.detail instanceof Error && (e.detail = r(e.detail)),
            this._send(new Le(this._workerId, t, void 0, r(e)));
        },
      );
    }
  ...
  function Oe(e, t, n) {
    const r = (e) =>
      ...
      o = {};
    for (const a of e)
      Me(a) ? (o[a] = i(a)) : Re(a) ? (o[a] = n(a, void 0)) : (o[a] = r(a));
    return o;
  }
  class Te {
    constructor(e, t) {
    ...
    _handleEvent(e, t) {
      ...
      if (Re(e)) {
        ...
        if ("function" !== typeof t)
          throw new Error("Missing event ".concat(e, " on request handler."));
        return t;
      }
    ...
    initialize(e, t, n, r) {
      ...
      return this._requestHandlerFactory
        ? ((this._requestHandler = this._requestHandlerFactory(i)),
          Promise.resolve(se(this._requestHandler)))
        : (t &&
  ...
  function Ke(e, t) {
    const n =
      (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 32) - t;
  ...
  class Fe {
    ...
    digest() {
      return (
        this._finished ||
          ...
          this._wrapUp()),
        Ve(this._h0) + Ve(this._h1) + Ve(this._h2) + Ve(this._h3) + Ve(this._h4)
      );
    }
    _wrapUp() {
      (this._buff[this._buffLen++] = 128),
        De(this._buff, this._buffLen),
        this._buffLen > 56 && (this._step(), De(this._buff));
    ...
    _step() {
      ...
      for (let h = 0; h < 80; h++)
        h < 20
          ? ((n = (a & s) | (~a & l)), (r = 1518500249))
          : h < 40
            ? ((n = a ^ s ^ l), (r = 1859775393))
            : h < 60
              ? ((n = (a & s) | (a & l) | (s & l)), (r = 2400959708))
              : ((n = a ^ s ^ l), (r = 3395469782)),
          (i = (Ke(o, 5) + n + c + r + e.getUint32(4 * h, !1)) & 4294967295),
          (c = l),
          (l = s),
          (s = Ke(a, 30)),
          (a = o),
  ...
  function Ue(e, t, n) {
    return new ze(new Be(e), new Be(t)).ComputeDiff(n).changes;
  }
  class qe {
    static Assert(e, t) {
  ...
  class ze {
    constructor(e, t) {
      ...
      const [r, i, o] = ze._getElements(e),
        [a, s, l] = ze._getElements(t);
    ...
    static _getElements(e) {
      ...
      if (ze._isStringArray(t)) {
        ...
        for (let n = 0, r = t.length; n < r; n++) e[n] = Ie(t[n], 0);
        return [t, e, !0];
      }
    ...
    ElementsAreStrictEqual(e, t) {
      ...
      return (
        ze._getStrictElement(this._originalSequence, e) ===
        ze._getStrictElement(this._modifiedSequence, t)
      );
    }
    ...
    _ComputeDiff(e, t, n, r, i) {
      ...
      return (
        i && (a = this.PrettifyChanges(a)), { quitEarly: o[0], changes: a }
      );
    }
    ...
    WALKTRACE(e, t, n, r, i, o, a, s, l, c, h, u, d, f, m, g, b, C) {
      ...
      do {
        ...
        t === y || (t < S && l[t - 1] < l[t + 1])
          ? ((f = (h = l[t + 1]) - v - r),
            h < L && _.MarkNextChange(),
            (L = h),
            _.AddModifiedElement(h + 1, f),
            (v = t + 1 - e))
          : ((f = (h = l[t - 1] + 1) - v - r),
            h < L && _.MarkNextChange(),
            (L = h - 1),
            _.AddOriginalElement(h, f + 1),
            (v = t - 1 - e)),
          N >= 0 &&
        ...
        do {
          ...
          e === y || (e < S && c[e - 1] >= c[e + 1])
            ? ((f = (h = c[e + 1] - 1) - v - s),
              h > L && _.MarkNextChange(),
              (L = h + 1),
              _.AddOriginalElement(h + 1, f + 1),
              (v = e + 1 - i))
            : ((f = (h = c[e - 1]) - v - s),
              h > L && _.MarkNextChange(),
              (L = h),
              _.AddModifiedElement(h + 1, f + 1),
              (v = e - 1 - i)),
            N >= 0 &&
    ...
    ComputeRecursionPoint(e, t, n, r, i, o, a) {
      ...
      for (let S = 1; S <= f / 2 + 1; S++) {
        let f = 0,
          v = 0;
        (c = this.ClipDiagonalBound(C - S, S, C, m)),
        ...
        if (
          ...
          !this.ContinueProcessingPredicate(f, L)
        )
          return (
            (a[0] = !0),
            (i[0] = f),
            ...
            L > 0 && S <= 1448
              ...
              : (e++, n++, [new xe(e, t - e + 1, n, r - n + 1)])
          );
        (u = this.ClipDiagonalBound(p - S, S, p, m)),
          (d = this.ClipDiagonalBound(p + S, S, p, m));
        for (let m = u; m <= d; m += 2) {
          (s =
            m === u || (m < d && b[m - 1] >= b[m + 1])
              ? b[m + 1] - 1
          ...
          if (((b[m] = s), y && Math.abs(m - C) <= S && s <= g[m]))
            return (
              (i[0] = s),
              (o[0] = l),
              f >= g[m] && S <= 1448
        ...
        if (S <= 1447) {
          ...
          (e[0] = C - c + 1),
            He.Copy2(g, c, e, 1, h - c + 1),
            this.m_forwardHistory.push(e),
            (e = new Int32Array(d - u + 2)),
            (e[0] = p - u + 1),
            He.Copy2(b, u, e, 1, d - u + 1),
      ...
      for (let t = e.length - 1; t >= 0; t--) {
        ...
        for (let e = 1; ; e++) {
          ...
          if (o && !this.OriginalElementsAreEqual(t, t + n.originalLength))
            break;
          if (a && !this.ModifiedElementsAreEqual(c, c + n.modifiedLength))
            break;
          const h =
            (t === r && c === i ? 5 : 0) +
    ...
    ConcatenateChanges(e, t) {
      ...
      if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
        ...
        return (
          He.Copy(e, 0, r, 0, e.length - 1),
          (r[e.length - 1] = n[0]),
          He.Copy(t, 1, r, e.length, t.length - 1),
          r
        );
      }
      {
        ...
        return (
          He.Copy(e, 0, n, 0, e.length), He.Copy(t, 0, n, e.length, t.length), n
        );
      }
    }
  ...
  if (
    "undefined" !== typeof U.vscode &&
    "undefined" !== typeof U.vscode.process
  ) {
  ...
  class Xe extends Error {
    constructor(e, t, n) {
      ...
      let o = 'The "'
        ...
        .concat(r, " of type ")
        .concat(t);
      (o += ". Received type ".concat(typeof n)),
        super(o),
        (this.code = "ERR_INVALID_ARG_TYPE");
    }
  }
  function $e(e, t) {
    if ("string" !== typeof e) throw new Xe(t, "string", e);
  }
  function et(e) {
    return e === Ze || e === Je;
  }
      ...
      if (r(l)) {
        if (a === c - 1 || 1 === s);
          ...
          if (
            i.length < 2 ||
            2 !== o ||
            i.charCodeAt(i.length - 1) !== Ye ||
            i.charCodeAt(i.length - 2) !== Ye
          ) {
            if (i.length > 2) {
              const e = i.lastIndexOf(n);
              -1 === e
                ? ((i = ""), (o = 0))
                : ((i = i.slice(0, e)), (o = i.length - 1 - i.lastIndexOf(n))),
                (a = c),
                (s = 0);
              continue;
            }
  ...
  function it(e, t) {
    if (null === t || "object" !== typeof t)
      throw new Xe("pathObject", "Object", t);
  ...
  const ot = {
      resolve() {
        ...
        for (let r = arguments.length - 1; r >= -1; r--) {
          ...
          if (1 === o) et(c) && ((a = 1), (l = !0));
            ...
            if (((l = !0), et(i.charCodeAt(1)))) {
              let e = 2,
                t = e;
              for (; e < o && !et(i.charCodeAt(e)); ) e++;
              if (e < o && e !== t) {
                const n = i.slice(t, e);
                for (t = e; e < o && et(i.charCodeAt(e)); ) e++;
                if (e < o && e !== t) {
                  for (t = e; e < o && !et(i.charCodeAt(e)); ) e++;
                  (e !== o && e === t) ||
                    ((s = "\\\\".concat(n, "\\").concat(i.slice(t, e))),
                    (a = e));
                }
              }
            } else a = 1;
      ...
      normalize(e) {
        ...
        if (1 === t) return tt(o) ? "\\" : e;
        if (et(o))
          if (((i = !0), et(e.charCodeAt(1)))) {
            let i = 2,
              o = i;
            for (; i < t && !et(e.charCodeAt(i)); ) i++;
            if (i < t && i !== o) {
              const a = e.slice(o, i);
              for (o = i; i < t && et(e.charCodeAt(i)); ) i++;
              if (i < t && i !== o) {
                for (o = i; i < t && !et(e.charCodeAt(i)); ) i++;
                if (i === t)
                  return "\\\\".concat(a, "\\").concat(e.slice(o), "\\");
                i !== o &&
                  ((n = "\\\\".concat(a, "\\").concat(e.slice(o, i))), (r = i));
              }
            }
          } else r = 1;
        else
          nt(o) &&
            ...
            ((n = e.slice(0, 2)),
            (r = 2),
            t > 2 && et(e.charCodeAt(2)) && ((i = !0), (r = 3)));
        let a = r < t ? rt(e.slice(r), !i, "\\", et) : "";
        return (
          0 !== a.length || i || (a = "."),
          a.length > 0 && et(e.charCodeAt(t - 1)) && (a += "\\"),
          void 0 === n
            ? i
              ? "\\".concat(a)
              : a
      ...
      isAbsolute(e) {
        ...
        return (
          et(n) ||
          (t > 2 && nt(n) && e.charCodeAt(1) === Qe && et(e.charCodeAt(2)))
        );
      },
      join() {
        ...
        for (let i = 0; i < arguments.length; ++i) {
          ...
          $e(n, "path"),
            n.length > 0 &&
              (void 0 === e ? (e = t = n) : (e += "\\".concat(n)));
        }
        if (void 0 === e) return ".";
        let n = !0,
          r = 0;
        if ("string" === typeof t && et(t.charCodeAt(0))) {
          ++r;
          const e = t.length;
          e > 1 &&
            et(t.charCodeAt(1)) &&
            (++r, e > 2 && (et(t.charCodeAt(2)) ? ++r : (n = !1)));
        }
        if (n) {
          for (; r < e.length && et(e.charCodeAt(r)); ) r++;
          r >= 2 && (e = "\\".concat(e.slice(r)));
        }
        return ot.normalize(e);
      },
      relative(e, t) {
        if (($e(e, "from"), $e(t, "to"), e === t)) return "";
        const n = ot.resolve(e),
          r = ot.resolve(t);
        if (n === r) return "";
        if ((e = n.toLowerCase()) === (t = r.toLowerCase())) return "";
        let i = 0;
        for (; i < e.length && e.charCodeAt(i) === Je; ) i++;
        let o = e.length;
        for (; o - 1 > i && e.charCodeAt(o - 1) === Je; ) o--;
        const a = o - i;
        let s = 0;
        for (; s < t.length && t.charCodeAt(s) === Je; ) s++;
        let l = t.length;
        for (; l - 1 > s && t.charCodeAt(l - 1) === Je; ) l--;
        const c = l - s,
          h = a < c ? a : c;
        let u = -1,
          d = 0;
        ...
        if (d !== h) {
          ...
          if (c > h) {
            if (t.charCodeAt(s + d) === Je) return r.slice(s + d + 1);
            if (2 === d) return r.slice(s + d);
          }
          a > h && (e.charCodeAt(i + d) === Je ? (u = d) : 2 === d && (u = 3)),
            -1 === u && (u = 0);
        }
        let f = "";
        for (d = i + u + 1; d <= o; ++d)
          (d !== o && e.charCodeAt(d) !== Je) ||
            (f += 0 === f.length ? ".." : "\\..");
        return (
          (s += u),
          f.length > 0
            ? "".concat(f).concat(r.slice(s, l))
            : (r.charCodeAt(s) === Je && ++s, r.slice(s, l))
        );
      },
      toNamespacedPath(e) {
        if ("string" !== typeof e) return e;
        if (0 === e.length) return "";
        const t = ot.resolve(e);
        if (t.length <= 2) return e;
        if (t.charCodeAt(0) === Je) {
          if (t.charCodeAt(1) === Je) {
            const e = t.charCodeAt(2);
            if (63 !== e && e !== Ye) return "\\\\?\\UNC\\".concat(t.slice(2));
          }
        } else if (
          nt(t.charCodeAt(0)) &&
          t.charCodeAt(1) === Qe &&
      ...
      dirname(e) {
        ...
        if (1 === t) return et(i) ? e : ".";
        if (et(i)) {
          if (((n = r = 1), et(e.charCodeAt(1)))) {
            let i = 2,
              o = i;
            for (; i < t && !et(e.charCodeAt(i)); ) i++;
            if (i < t && i !== o) {
          ...
          nt(i) &&
            e.charCodeAt(1) === Qe &&
            ((n = t > 2 && et(e.charCodeAt(2)) ? 3 : 2), (r = n));
        let o = -1,
          a = !0;
        for (let s = t - 1; s >= r; --s)
      ...
      parse(e) {
        ...
        let r = 0,
          i = e.charCodeAt(0);
        if (1 === n)
          return et(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
        if (et(i)) {
          if (((r = 1), et(e.charCodeAt(1)))) {
            let t = 2,
              i = t;
            for (; t < n && !et(e.charCodeAt(t)); ) t++;
            if (t < n && t !== i) {
              for (i = t; t < n && et(e.charCodeAt(t)); ) t++;
              if (t < n && t !== i) {
                for (i = t; t < n && !et(e.charCodeAt(t)); ) t++;
                t === n ? (r = t) : t !== i && (r = t + 1);
              }
        ...
        } else if (nt(i) && e.charCodeAt(1) === Qe) {
          if (n <= 2) return (t.root = t.dir = e), t;
          if (((r = 2), et(e.charCodeAt(2)))) {
    ...
    at = {
      resolve() {
        ...
        for (let n = arguments.length - 1; n >= -1 && !t; n--) {
          ...
          $e(r, "path"),
            0 !== r.length &&
              ((e = "".concat(r, "/").concat(e)), (t = r.charCodeAt(0) === Ze));
        }
        return (
          (e = rt(e, !t, "/", tt)), t ? "/".concat(e) : e.length > 0 ? e : "."
        );
      },
      normalize(e) {
        if (($e(e, "path"), 0 === e.length)) return ".";
        const t = e.charCodeAt(0) === Ze,
          n = e.charCodeAt(e.length - 1) === Ze;
        return 0 === (e = rt(e, !t, "/", tt)).length
          ? t
            ? "/"
            : n
              ? "./"
      ...
      isAbsolute: (e) => (
        $e(e, "path"), e.length > 0 && e.charCodeAt(0) === Ze
      ),
      join() {
        if (0 === arguments.length) return ".";
        let e;
        ...
        return void 0 === e ? "." : at.normalize(e);
      },
      relative(e, t) {
        if (($e(e, "from"), $e(t, "to"), e === t)) return "";
        if ((e = at.resolve(e)) === (t = at.resolve(t))) return "";
        const n = e.length,
          r = n - 1,
          i = t.length - 1,
          o = r < i ? r : i;
        ...
        if (s === o)
          if (i > o) {
            if (t.charCodeAt(1 + s) === Ze) return t.slice(1 + s + 1);
            if (0 === s) return t.slice(1 + s);
          } else
            r > o &&
              (e.charCodeAt(1 + s) === Ze ? (a = s) : 0 === s && (a = 0));
        let l = "";
        for (s = 1 + a + 1; s <= n; ++s)
          (s !== n && e.charCodeAt(s) !== Ze) ||
            (l += 0 === l.length ? ".." : "/..");
  ...
  (at.win32 = ot.win32 = ot), (at.posix = ot.posix = at);
  "win32" === Ge ? ot.normalize : at.normalize,
    "win32" === Ge ? ot.resolve : at.resolve,
    "win32" === Ge ? ot.relative : at.relative,
    "win32" === Ge ? ot.dirname : at.dirname,
    "win32" === Ge ? ot.basename : at.basename,
    "win32" === Ge ? ot.extname : at.extname,
    "win32" === Ge ? ot.sep : at.sep;
  const st = /^\w[\w\d+.-]*$/,
    lt = /^\//,
    ct = /^\/\//;
  function ht(e, t) {
  ...
  class mt {
    constructor(e, t, n, r, i) {
      ...
      "object" === typeof e
        ? ((this.scheme = e.scheme || ut),
          (this.authority = e.authority || ut),
          (this.path = e.path || ut),
          (this.query = e.query || ut),
          (this.fragment = e.fragment || ut))
    ...
    with(e) {
      ...
      return (
        void 0 === t ? (t = this.scheme) : null === t && (t = ut),
        void 0 === n ? (n = this.authority) : null === n && (n = ut),
        void 0 === r ? (r = this.path) : null === r && (r = ut),
        void 0 === i ? (i = this.query) : null === i && (i = ut),
        void 0 === o ? (o = this.fragment) : null === o && (o = ut),
        t === this.scheme &&
        n === this.authority &&
        r === this.path &&
        i === this.query &&
    ...
    static parse(e) {
      ...
      return n
        ...
        : new bt(ut, ut, ut, ut, ut);
    }
    static file(e) {
      let t = ut;
      if ((j && (e = e.replace(/\\/g, dt)), e[0] === dt && e[1] === dt)) {
        const n = e.indexOf(dt, 2);
        -1 === n
          ? ((t = e.substring(2)), (e = dt))
          : ((t = e.substring(2, n)), (e = e.substring(n) || dt));
      }
      return new bt("file", t, e, ut, ut);
    }
    static from(e) {
      const t = new bt(e.scheme, e.authority, e.path, e.query, e.fragment);
      return ht(t, !0), t;
    }
    static joinPath(e) {
      if (!e.path)
      ...
      if (e) {
        if (e instanceof mt) return e;
        {
          ...
          return (
            ...
            (t._fsPath = e._sep === gt ? e.fsPath : null),
            t
          );
        }
      }
  ...
  class bt extends mt {
    ...
    get fsPath() {
      return this._fsPath || (this._fsPath = _t(this, !1)), this._fsPath;
    }
    toString() {
      return arguments.length > 0 && void 0 !== arguments[0] && arguments[0]
        ? yt(this, !0)
        : (this._formatted || (this._formatted = yt(this, !1)),
          this._formatted);
    }
    toJSON() {
      const e = { $mid: 1 };
      return (
        this._fsPath && ((e.fsPath = this._fsPath), (e._sep = gt)),
  ...
  function wt(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const r = e.charCodeAt(n);
      35 === r || 63 === r
        ? (void 0 === t && (t = e.substr(0, n)), (t += Ct[r]))
        : void 0 !== t && (t += e[n]);
    }
    return void 0 !== t ? t : e;
  }
    ...
    if (a) {
      if (a.length >= 3 && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2)) {
        ...
        e >= 65 &&
          e <= 90 &&
          (a = "/"
            .concat(String.fromCharCode(e + 32), ":")
            .concat(a.substr(3)));
      } else if (a.length >= 2 && 58 === a.charCodeAt(1)) {
        const e = a.charCodeAt(0);
        e >= 65 &&
          e <= 90 &&
          (a = "".concat(String.fromCharCode(e + 32), ":").concat(a.substr(2)));
      }
      r += n(a, !0);
    }
    return (
  ...
  function Lt(e) {
    return e.match(vt) ? e.replace(vt, (e) => St(e)) : e;
  }
  class Nt {
    constructor(e, t) {
      ...
      let e =
        ...
        t =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : this.column;
      return e === this.lineNumber && t === this.column ? this : new Nt(e, t);
    }
    delta() {
      let e =
    ...
    isBeforeOrEqual(e) {
      return Nt.isBeforeOrEqual(this, e);
    }
    ...
    static lift(e) {
      return new Nt(e.lineNumber, e.column);
    }
  ...
  class Et {
    ...
    containsPosition(e) {
      return Et.containsPosition(this, e);
    }
    ...
    containsRange(e) {
      return Et.containsRange(this, e);
    }
    ...
    strictContainsRange(e) {
      return Et.strictContainsRange(this, e);
    }
    ...
    intersectRanges(e) {
      return Et.intersectRanges(this, e);
    }
    static intersectRanges(e, t) {
      ...
      const a = t.startLineNumber,
        ...
        c = t.endColumn;
      return (
        n < a ? ((n = a), (r = s)) : n === a && (r = Math.max(r, s)),
        i > l ? ((i = l), (o = c)) : i === l && (o = Math.min(o, c)),
        n > i || (n === i && r > o) ? null : new Et(n, r, i, o)
      );
    }
    equalsRange(e) {
      return Et.equalsRange(this, e);
    }
    ...
    getEndPosition() {
      return Et.getEndPosition(this);
    }
    static getEndPosition(e) {
      return new Nt(e.endLineNumber, e.endColumn);
    }
    getStartPosition() {
      return Et.getStartPosition(this);
    }
    static getStartPosition(e) {
      return new Nt(e.startLineNumber, e.startColumn);
    }
    toString() {
      return (
        "[" +
    ...
    setEndPosition(e, t) {
      return new Et(this.startLineNumber, this.startColumn, e, t);
    }
    setStartPosition(e, t) {
      return new Et(e, t, this.endLineNumber, this.endColumn);
    }
    collapseToStart() {
      return Et.collapseToStart(this);
    }
    ...
    static fromPositions(e) {
      ...
      return new Et(e.lineNumber, e.column, t.lineNumber, t.column);
    }
    static lift(e) {
      return e
        ? new Et(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn)
        : null;
    }
    static isIRange(e) {
      return (
  ...
  class kt {
    ...
    createCharSequence(e, t, n) {
      ...
      for (let s = t; s <= n; s++) {
        ...
        !e &&
          s < n &&
          ((r[a] = 10), (i[a] = s + 1), (o[a] = t.length + 1), a++);
      }
      return new Rt(r, i, o);
    }
  }
        ...
        this._charCodes
          .map(
            (e, t) =>
              ...
              "-("
                .concat(this._lineNumbers[t], ",")
                .concat(this._columns[t], ")"),
          )
          .join(", ") +
        "]"
      );
      ...
      if (
        ...
        if (o.getElements().length > 0 && s.getElements().length > 0) {
          ...
          for (let t = 0, n = e.length; t < n; t++)
            u.push(Mt.createFromDiffChange(e[t], o, s));
        }
      }
      return new Ot(s, l, c, h, u);
    }
  }
  class Tt {
    constructor(e, t, n) {
      (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
        ...
        (this.original = new kt(e)),
        (this.modified = new kt(t)),
        (this.continueLineDiff = It(n.maxComputationTime)),
        (this.continueCharDiff = It(
          ...
          if (e !== t) {
            {
              ...
              (n > 1 || a > 1) &&
                this._pushTrimWhitespaceCharChange(r, i + 1, 1, n, o + 1, 1, a);
            }
            {
              let n = Pt(e, 1),
                a = Pt(t, 1);
              ...
              (n < s || a < l) &&
                this._pushTrimWhitespaceCharChange(r, i + 1, n, s, o + 1, a, l);
            }
          }
          i++, o++;
        }
    ...
    _pushTrimWhitespaceCharChange(e, t, n, r, i, o, a) {
      ...
      let s;
      this.shouldComputeCharChanges && (s = [new Mt(t, n, t, r, i, o, i, a)]),
        e.push(new Ot(t, t, i, i, s));
    }
    _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, a) {
      ...
      return (
        ...
        this.shouldComputeCharChanges &&
          l.charChanges &&
          l.charChanges.push(new Mt(t, n, t, r, i, o, i, a)),
        !0)
      );
    }
  }
  ...
  class Ft {
    ...
    getPrefixSum(e) {
      return e < 0 ? 0 : ((e = Vt(e)), this._getPrefixSum(e));
    }
    _getPrefixSum(e) {
      ...
      for (const n of t)
        this._acceptDeleteRange(n.range),
          this._acceptInsertText(
            new Nt(n.range.startLineNumber, n.range.startColumn),
            n.text,
          );
  ...
  function Wt(e, t, n, r, i) {
    if ((i || (i = c.first(Ht)), n.length > i.maxLen)) {
      let o = e - i.maxLen / 2;
      return (
        o < 0 ? (o = 0) : (r += o),
        Wt(e, t, (n = n.substring(o, e + i.maxLen / 2)), r, i)
      );
    }
    const o = Date.now(),
      a = e - 1 - r;
    let s = -1,
      l = null;
    for (let c = 1; !(Date.now() - o >= i.timeBudget); c++) {
      const e = a - i.windowSize * c;
  ...
  Ht.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  class jt {
    constructor(e) {
      const t = Dt(e);
    ...
    static computeLinks(e) {
      ...
      const n = (function () {
          if (null === Jt) {
            ...
            const e =
              " \t<>'\"\u3001\u3002\uff61\uff64\uff0c\uff0e\uff1a\uff1b\u2018\u3008\u300c\u300e\u3014\uff08\uff3b\uff5b\uff62\uff63\uff5d\uff3d\uff09\u3015\u300f\u300d\u3009\u2019\uff40\uff5e\u2026";
            for (let n = 0; n < e.length; n++) Jt.set(e.charCodeAt(n), 1);
            const t = ".,;:";
            for (let n = 0; n < t.length; n++) Jt.set(t.charCodeAt(n), 2);
          }
          return Jt;
        })(),
        r = [];
      for (let i = 1, o = e.getLineCount(); i <= o; i++) {
        ...
        for (; s < a; ) {
          ...
          if (13 === h) {
            ...
            1 === t && (r.push(Qt._createLink(n, o, i, l, s)), (e = !0));
          } else if (12 === h) {
            let t;
            91 === a ? ((d = !0), (t = 0)) : (t = n.get(a)),
              1 === t ? (e = !0) : (h = 13);
          } else (h = t.nextState(h, a)), 0 === h && (e = !0);
          e && ((h = 1), (u = !1), (d = !1), (m = !1), (l = s + 1), (c = a)),
            s++;
        }
        13 === h && r.push(Qt._createLink(n, o, i, l, a));
      }
      return r;
    }
  }
  ...
  Xt.INSTANCE = new Xt();
  const $t = Object.freeze(function (e, t) {
  ...
  const on = new rn(),
    ...
    fn = [],
    mn = [];
  for (let Rr = 0; Rr <= 193; Rr++) fn[Rr] = -1;
  for (let Rr = 0; Rr <= 127; Rr++) mn[Rr] = -1;
  var gn, bn;
  !(function () {
    const e = "",
      t = [
        ...
        if (((n[s] = !0), !l))
          throw new Error(
            "String representation missing for key code "
              .concat(s, " around scan code ")
              .concat(a),
          );
        on.define(s, l), an.define(s, u || l), sn.define(s, d || u || l);
      }
      c && (ln[c] = s), h && (cn[h] = s);
    }
    mn[3] = 46;
  ...
  class Cn extends Et {
    ...
    setEndPosition(e, t) {
      return 0 === this.getDirection()
        ? new Cn(this.startLineNumber, this.startColumn, e, t)
        : new Cn(e, t, this.startLineNumber, this.startColumn);
    }
    getPosition() {
      return new Nt(this.positionLineNumber, this.positionColumn);
    }
    getSelectionStart() {
      return new Nt(this.selectionStartLineNumber, this.selectionStartColumn);
    }
    setStartPosition(e, t) {
      return 0 === this.getDirection()
        ? new Cn(e, t, this.endLineNumber, this.endColumn)
        : new Cn(this.endLineNumber, this.endColumn, e, t);
    }
    static fromPositions(e) {
      let t =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
    ...
    static fromRange(e, t) {
      return 0 === t
        ? new Cn(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn)
        : new Cn(
            e.endLineNumber,
            e.endColumn,
            e.startLineNumber,
    ...
    static createWithDirection(e, t, n, r, i) {
      return 0 === i ? new Cn(e, t, n, r) : new Cn(n, r, e, t);
    }
  }
  class pn {
    constructor(e, t, n) {
    ...
    static getAll() {
      return pn._allCodicons;
    }
  }
  (pn._allCodicons = []),
    (pn.add = new pn("add", { fontCharacter: "\\ea60" })),
    (pn.plus = new pn("plus", pn.add.definition)),
    (pn.gistNew = new pn("gist-new", pn.add.definition)),
    (pn.repoCreate = new pn("repo-create", pn.add.definition)),
    (pn.lightbulb = new pn("lightbulb", { fontCharacter: "\\ea61" })),
    (pn.lightBulb = new pn("light-bulb", { fontCharacter: "\\ea61" })),
    (pn.repo = new pn("repo", { fontCharacter: "\\ea62" })),
    (pn.repoDelete = new pn("repo-delete", { fontCharacter: "\\ea62" })),
    (pn.gistFork = new pn("gist-fork", { fontCharacter: "\\ea63" })),
    (pn.repoForked = new pn("repo-forked", { fontCharacter: "\\ea63" })),
    (pn.gitPullRequest = new pn("git-pull-request", {
      fontCharacter: "\\ea64",
    })),
    (pn.gitPullRequestAbandoned = new pn("git-pull-request-abandoned", {
      fontCharacter: "\\ea64",
    })),
    (pn.recordKeys = new pn("record-keys", { fontCharacter: "\\ea65" })),
    (pn.keyboard = new pn("keyboard", { fontCharacter: "\\ea65" })),
    (pn.tag = new pn("tag", { fontCharacter: "\\ea66" })),
    (pn.tagAdd = new pn("tag-add", { fontCharacter: "\\ea66" })),
    (pn.tagRemove = new pn("tag-remove", { fontCharacter: "\\ea66" })),
    (pn.person = new pn("person", { fontCharacter: "\\ea67" })),
    (pn.personFollow = new pn("person-follow", { fontCharacter: "\\ea67" })),
    (pn.personOutline = new pn("person-outline", { fontCharacter: "\\ea67" })),
    (pn.personFilled = new pn("person-filled", { fontCharacter: "\\ea67" })),
    (pn.gitBranch = new pn("git-branch", { fontCharacter: "\\ea68" })),
    (pn.gitBranchCreate = new pn("git-branch-create", {
      fontCharacter: "\\ea68",
    })),
    (pn.gitBranchDelete = new pn("git-branch-delete", {
      fontCharacter: "\\ea68",
    })),
    (pn.sourceControl = new pn("source-control", { fontCharacter: "\\ea68" })),
    (pn.mirror = new pn("mirror", { fontCharacter: "\\ea69" })),
    (pn.mirrorPublic = new pn("mirror-public", { fontCharacter: "\\ea69" })),
    (pn.star = new pn("star", { fontCharacter: "\\ea6a" })),
    (pn.starAdd = new pn("star-add", { fontCharacter: "\\ea6a" })),
    (pn.starDelete = new pn("star-delete", { fontCharacter: "\\ea6a" })),
    (pn.starEmpty = new pn("star-empty", { fontCharacter: "\\ea6a" })),
    (pn.comment = new pn("comment", { fontCharacter: "\\ea6b" })),
    (pn.commentAdd = new pn("comment-add", { fontCharacter: "\\ea6b" })),
    (pn.alert = new pn("alert", { fontCharacter: "\\ea6c" })),
    (pn.warning = new pn("warning", { fontCharacter: "\\ea6c" })),
    (pn.search = new pn("search", { fontCharacter: "\\ea6d" })),
    (pn.searchSave = new pn("search-save", { fontCharacter: "\\ea6d" })),
    (pn.logOut = new pn("log-out", { fontCharacter: "\\ea6e" })),
    (pn.signOut = new pn("sign-out", { fontCharacter: "\\ea6e" })),
    (pn.logIn = new pn("log-in", { fontCharacter: "\\ea6f" })),
    (pn.signIn = new pn("sign-in", { fontCharacter: "\\ea6f" })),
    (pn.eye = new pn("eye", { fontCharacter: "\\ea70" })),
    (pn.eyeUnwatch = new pn("eye-unwatch", { fontCharacter: "\\ea70" })),
    (pn.eyeWatch = new pn("eye-watch", { fontCharacter: "\\ea70" })),
    (pn.circleFilled = new pn("circle-filled", { fontCharacter: "\\ea71" })),
    (pn.primitiveDot = new pn("primitive-dot", { fontCharacter: "\\ea71" })),
    (pn.closeDirty = new pn("close-dirty", { fontCharacter: "\\ea71" })),
    (pn.debugBreakpoint = new pn("debug-breakpoint", {
      fontCharacter: "\\ea71",
    })),
    (pn.debugBreakpointDisabled = new pn("debug-breakpoint-disabled", {
      fontCharacter: "\\ea71",
    })),
    (pn.debugHint = new pn("debug-hint", { fontCharacter: "\\ea71" })),
    (pn.primitiveSquare = new pn("primitive-square", {
      fontCharacter: "\\ea72",
    })),
    (pn.edit = new pn("edit", { fontCharacter: "\\ea73" })),
    (pn.pencil = new pn("pencil", { fontCharacter: "\\ea73" })),
    (pn.info = new pn("info", { fontCharacter: "\\ea74" })),
    (pn.issueOpened = new pn("issue-opened", { fontCharacter: "\\ea74" })),
    (pn.gistPrivate = new pn("gist-private", { fontCharacter: "\\ea75" })),
    (pn.gitForkPrivate = new pn("git-fork-private", {
      fontCharacter: "\\ea75",
    })),
    (pn.lock = new pn("lock", { fontCharacter: "\\ea75" })),
    (pn.mirrorPrivate = new pn("mirror-private", { fontCharacter: "\\ea75" })),
    (pn.close = new pn("close", { fontCharacter: "\\ea76" })),
    (pn.removeClose = new pn("remove-close", { fontCharacter: "\\ea76" })),
    (pn.x = new pn("x", { fontCharacter: "\\ea76" })),
    (pn.repoSync = new pn("repo-sync", { fontCharacter: "\\ea77" })),
    (pn.sync = new pn("sync", { fontCharacter: "\\ea77" })),
    (pn.clone = new pn("clone", { fontCharacter: "\\ea78" })),
    (pn.desktopDownload = new pn("desktop-download", {
      fontCharacter: "\\ea78",
    })),
    (pn.beaker = new pn("beaker", { fontCharacter: "\\ea79" })),
    (pn.microscope = new pn("microscope", { fontCharacter: "\\ea79" })),
    (pn.vm = new pn("vm", { fontCharacter: "\\ea7a" })),
    (pn.deviceDesktop = new pn("device-desktop", { fontCharacter: "\\ea7a" })),
    (pn.file = new pn("file", { fontCharacter: "\\ea7b" })),
    (pn.fileText = new pn("file-text", { fontCharacter: "\\ea7b" })),
    (pn.more = new pn("more", { fontCharacter: "\\ea7c" })),
    (pn.ellipsis = new pn("ellipsis", { fontCharacter: "\\ea7c" })),
    (pn.kebabHorizontal = new pn("kebab-horizontal", {
      fontCharacter: "\\ea7c",
    })),
    (pn.mailReply = new pn("mail-reply", { fontCharacter: "\\ea7d" })),
    (pn.reply = new pn("reply", { fontCharacter: "\\ea7d" })),
    (pn.organization = new pn("organization", { fontCharacter: "\\ea7e" })),
    (pn.organizationFilled = new pn("organization-filled", {
      fontCharacter: "\\ea7e",
    })),
    (pn.organizationOutline = new pn("organization-outline", {
      fontCharacter: "\\ea7e",
    })),
    (pn.newFile = new pn("new-file", { fontCharacter: "\\ea7f" })),
    (pn.fileAdd = new pn("file-add", { fontCharacter: "\\ea7f" })),
    (pn.newFolder = new pn("new-folder", { fontCharacter: "\\ea80" })),
    (pn.fileDirectoryCreate = new pn("file-directory-create", {
      fontCharacter: "\\ea80",
    })),
    (pn.trash = new pn("trash", { fontCharacter: "\\ea81" })),
    (pn.trashcan = new pn("trashcan", { fontCharacter: "\\ea81" })),
    (pn.history = new pn("history", { fontCharacter: "\\ea82" })),
    (pn.clock = new pn("clock", { fontCharacter: "\\ea82" })),
    (pn.folder = new pn("folder", { fontCharacter: "\\ea83" })),
    (pn.fileDirectory = new pn("file-directory", { fontCharacter: "\\ea83" })),
    (pn.symbolFolder = new pn("symbol-folder", { fontCharacter: "\\ea83" })),
    (pn.logoGithub = new pn("logo-github", { fontCharacter: "\\ea84" })),
    (pn.markGithub = new pn("mark-github", { fontCharacter: "\\ea84" })),
    (pn.github = new pn("github", { fontCharacter: "\\ea84" })),
    (pn.terminal = new pn("terminal", { fontCharacter: "\\ea85" })),
    (pn.console = new pn("console", { fontCharacter: "\\ea85" })),
    (pn.repl = new pn("repl", { fontCharacter: "\\ea85" })),
    (pn.zap = new pn("zap", { fontCharacter: "\\ea86" })),
    (pn.symbolEvent = new pn("symbol-event", { fontCharacter: "\\ea86" })),
    (pn.error = new pn("error", { fontCharacter: "\\ea87" })),
    (pn.stop = new pn("stop", { fontCharacter: "\\ea87" })),
    (pn.variable = new pn("variable", { fontCharacter: "\\ea88" })),
    (pn.symbolVariable = new pn("symbol-variable", {
      fontCharacter: "\\ea88",
    })),
    (pn.array = new pn("array", { fontCharacter: "\\ea8a" })),
    (pn.symbolArray = new pn("symbol-array", { fontCharacter: "\\ea8a" })),
    (pn.symbolModule = new pn("symbol-module", { fontCharacter: "\\ea8b" })),
    (pn.symbolPackage = new pn("symbol-package", { fontCharacter: "\\ea8b" })),
    (pn.symbolNamespace = new pn("symbol-namespace", {
      fontCharacter: "\\ea8b",
    })),
    (pn.symbolObject = new pn("symbol-object", { fontCharacter: "\\ea8b" })),
    (pn.symbolMethod = new pn("symbol-method", { fontCharacter: "\\ea8c" })),
    (pn.symbolFunction = new pn("symbol-function", {
      fontCharacter: "\\ea8c",
    })),
    (pn.symbolConstructor = new pn("symbol-constructor", {
      fontCharacter: "\\ea8c",
    })),
    (pn.symbolBoolean = new pn("symbol-boolean", { fontCharacter: "\\ea8f" })),
    (pn.symbolNull = new pn("symbol-null", { fontCharacter: "\\ea8f" })),
    (pn.symbolNumeric = new pn("symbol-numeric", { fontCharacter: "\\ea90" })),
    (pn.symbolNumber = new pn("symbol-number", { fontCharacter: "\\ea90" })),
    (pn.symbolStructure = new pn("symbol-structure", {
      fontCharacter: "\\ea91",
    })),
    (pn.symbolStruct = new pn("symbol-struct", { fontCharacter: "\\ea91" })),
    (pn.symbolParameter = new pn("symbol-parameter", {
      fontCharacter: "\\ea92",
    })),
    (pn.symbolTypeParameter = new pn("symbol-type-parameter", {
      fontCharacter: "\\ea92",
    })),
    (pn.symbolKey = new pn("symbol-key", { fontCharacter: "\\ea93" })),
    (pn.symbolText = new pn("symbol-text", { fontCharacter: "\\ea93" })),
    (pn.symbolReference = new pn("symbol-reference", {
      fontCharacter: "\\ea94",
    })),
    (pn.goToFile = new pn("go-to-file", { fontCharacter: "\\ea94" })),
    (pn.symbolEnum = new pn("symbol-enum", { fontCharacter: "\\ea95" })),
    (pn.symbolValue = new pn("symbol-value", { fontCharacter: "\\ea95" })),
    (pn.symbolRuler = new pn("symbol-ruler", { fontCharacter: "\\ea96" })),
    (pn.symbolUnit = new pn("symbol-unit", { fontCharacter: "\\ea96" })),
    (pn.activateBreakpoints = new pn("activate-breakpoints", {
      fontCharacter: "\\ea97",
    })),
    (pn.archive = new pn("archive", { fontCharacter: "\\ea98" })),
    (pn.arrowBoth = new pn("arrow-both", { fontCharacter: "\\ea99" })),
    (pn.arrowDown = new pn("arrow-down", { fontCharacter: "\\ea9a" })),
    (pn.arrowLeft = new pn("arrow-left", { fontCharacter: "\\ea9b" })),
    (pn.arrowRight = new pn("arrow-right", { fontCharacter: "\\ea9c" })),
    (pn.arrowSmallDown = new pn("arrow-small-down", {
      fontCharacter: "\\ea9d",
    })),
    (pn.arrowSmallLeft = new pn("arrow-small-left", {
      fontCharacter: "\\ea9e",
    })),
    (pn.arrowSmallRight = new pn("arrow-small-right", {
      fontCharacter: "\\ea9f",
    })),
    (pn.arrowSmallUp = new pn("arrow-small-up", { fontCharacter: "\\eaa0" })),
    (pn.arrowUp = new pn("arrow-up", { fontCharacter: "\\eaa1" })),
    (pn.bell = new pn("bell", { fontCharacter: "\\eaa2" })),
    (pn.bold = new pn("bold", { fontCharacter: "\\eaa3" })),
    (pn.book = new pn("book", { fontCharacter: "\\eaa4" })),
    (pn.bookmark = new pn("bookmark", { fontCharacter: "\\eaa5" })),
    (pn.debugBreakpointConditionalUnverified = new pn(
      "debug-breakpoint-conditional-unverified",
      { fontCharacter: "\\eaa6" },
    )),
    (pn.debugBreakpointConditional = new pn("debug-breakpoint-conditional", {
      fontCharacter: "\\eaa7",
    })),
    (pn.debugBreakpointConditionalDisabled = new pn(
      "debug-breakpoint-conditional-disabled",
      { fontCharacter: "\\eaa7" },
    )),
    (pn.debugBreakpointDataUnverified = new pn(
      "debug-breakpoint-data-unverified",
      { fontCharacter: "\\eaa8" },
    )),
    (pn.debugBreakpointData = new pn("debug-breakpoint-data", {
      fontCharacter: "\\eaa9",
    })),
    (pn.debugBreakpointDataDisabled = new pn("debug-breakpoint-data-disabled", {
      fontCharacter: "\\eaa9",
    })),
    (pn.debugBreakpointLogUnverified = new pn(
      "debug-breakpoint-log-unverified",
      { fontCharacter: "\\eaaa" },
    )),
    (pn.debugBreakpointLog = new pn("debug-breakpoint-log", {
      fontCharacter: "\\eaab",
    })),
    (pn.debugBreakpointLogDisabled = new pn("debug-breakpoint-log-disabled", {
      fontCharacter: "\\eaab",
    })),
    (pn.briefcase = new pn("briefcase", { fontCharacter: "\\eaac" })),
    (pn.broadcast = new pn("broadcast", { fontCharacter: "\\eaad" })),
    (pn.browser = new pn("browser", { fontCharacter: "\\eaae" })),
    (pn.bug = new pn("bug", { fontCharacter: "\\eaaf" })),
    (pn.calendar = new pn("calendar", { fontCharacter: "\\eab0" })),
    (pn.caseSensitive = new pn("case-sensitive", { fontCharacter: "\\eab1" })),
    (pn.check = new pn("check", { fontCharacter: "\\eab2" })),
    (pn.checklist = new pn("checklist", { fontCharacter: "\\eab3" })),
    (pn.chevronDown = new pn("chevron-down", { fontCharacter: "\\eab4" })),
    (pn.dropDownButton = new pn("drop-down-button", pn.chevronDown.definition)),
    (pn.chevronLeft = new pn("chevron-left", { fontCharacter: "\\eab5" })),
    (pn.chevronRight = new pn("chevron-right", { fontCharacter: "\\eab6" })),
    (pn.chevronUp = new pn("chevron-up", { fontCharacter: "\\eab7" })),
    (pn.chromeClose = new pn("chrome-close", { fontCharacter: "\\eab8" })),
    (pn.chromeMaximize = new pn("chrome-maximize", {
      fontCharacter: "\\eab9",
    })),
    (pn.chromeMinimize = new pn("chrome-minimize", {
      fontCharacter: "\\eaba",
    })),
    (pn.chromeRestore = new pn("chrome-restore", { fontCharacter: "\\eabb" })),
    (pn.circleOutline = new pn("circle-outline", { fontCharacter: "\\eabc" })),
    (pn.debugBreakpointUnverified = new pn("debug-breakpoint-unverified", {
      fontCharacter: "\\eabc",
    })),
    (pn.circleSlash = new pn("circle-slash", { fontCharacter: "\\eabd" })),
    (pn.circuitBoard = new pn("circuit-board", { fontCharacter: "\\eabe" })),
    (pn.clearAll = new pn("clear-all", { fontCharacter: "\\eabf" })),
    (pn.clippy = new pn("clippy", { fontCharacter: "\\eac0" })),
    (pn.closeAll = new pn("close-all", { fontCharacter: "\\eac1" })),
    (pn.cloudDownload = new pn("cloud-download", { fontCharacter: "\\eac2" })),
    (pn.cloudUpload = new pn("cloud-upload", { fontCharacter: "\\eac3" })),
    (pn.code = new pn("code", { fontCharacter: "\\eac4" })),
    (pn.collapseAll = new pn("collapse-all", { fontCharacter: "\\eac5" })),
    (pn.colorMode = new pn("color-mode", { fontCharacter: "\\eac6" })),
    (pn.commentDiscussion = new pn("comment-discussion", {
      fontCharacter: "\\eac7",
    })),
    (pn.compareChanges = new pn("compare-changes", {
      fontCharacter: "\\eafd",
    })),
    (pn.creditCard = new pn("credit-card", { fontCharacter: "\\eac9" })),
    (pn.dash = new pn("dash", { fontCharacter: "\\eacc" })),
    (pn.dashboard = new pn("dashboard", { fontCharacter: "\\eacd" })),
    (pn.database = new pn("database", { fontCharacter: "\\eace" })),
    (pn.debugContinue = new pn("debug-continue", { fontCharacter: "\\eacf" })),
    (pn.debugDisconnect = new pn("debug-disconnect", {
      fontCharacter: "\\ead0",
    })),
    (pn.debugPause = new pn("debug-pause", { fontCharacter: "\\ead1" })),
    (pn.debugRestart = new pn("debug-restart", { fontCharacter: "\\ead2" })),
    (pn.debugStart = new pn("debug-start", { fontCharacter: "\\ead3" })),
    (pn.debugStepInto = new pn("debug-step-into", { fontCharacter: "\\ead4" })),
    (pn.debugStepOut = new pn("debug-step-out", { fontCharacter: "\\ead5" })),
    (pn.debugStepOver = new pn("debug-step-over", { fontCharacter: "\\ead6" })),
    (pn.debugStop = new pn("debug-stop", { fontCharacter: "\\ead7" })),
    (pn.debug = new pn("debug", { fontCharacter: "\\ead8" })),
    (pn.deviceCameraVideo = new pn("device-camera-video", {
      fontCharacter: "\\ead9",
    })),
    (pn.deviceCamera = new pn("device-camera", { fontCharacter: "\\eada" })),
    (pn.deviceMobile = new pn("device-mobile", { fontCharacter: "\\eadb" })),
    (pn.diffAdded = new pn("diff-added", { fontCharacter: "\\eadc" })),
    (pn.diffIgnored = new pn("diff-ignored", { fontCharacter: "\\eadd" })),
    (pn.diffModified = new pn("diff-modified", { fontCharacter: "\\eade" })),
    (pn.diffRemoved = new pn("diff-removed", { fontCharacter: "\\eadf" })),
    (pn.diffRenamed = new pn("diff-renamed", { fontCharacter: "\\eae0" })),
    (pn.diff = new pn("diff", { fontCharacter: "\\eae1" })),
    (pn.discard = new pn("discard", { fontCharacter: "\\eae2" })),
    (pn.editorLayout = new pn("editor-layout", { fontCharacter: "\\eae3" })),
    (pn.emptyWindow = new pn("empty-window", { fontCharacter: "\\eae4" })),
    (pn.exclude = new pn("exclude", { fontCharacter: "\\eae5" })),
    (pn.extensions = new pn("extensions", { fontCharacter: "\\eae6" })),
    (pn.eyeClosed = new pn("eye-closed", { fontCharacter: "\\eae7" })),
    (pn.fileBinary = new pn("file-binary", { fontCharacter: "\\eae8" })),
    (pn.fileCode = new pn("file-code", { fontCharacter: "\\eae9" })),
    (pn.fileMedia = new pn("file-media", { fontCharacter: "\\eaea" })),
    (pn.filePdf = new pn("file-pdf", { fontCharacter: "\\eaeb" })),
    (pn.fileSubmodule = new pn("file-submodule", { fontCharacter: "\\eaec" })),
    (pn.fileSymlinkDirectory = new pn("file-symlink-directory", {
      fontCharacter: "\\eaed",
    })),
    (pn.fileSymlinkFile = new pn("file-symlink-file", {
      fontCharacter: "\\eaee",
    })),
    (pn.fileZip = new pn("file-zip", { fontCharacter: "\\eaef" })),
    (pn.files = new pn("files", { fontCharacter: "\\eaf0" })),
    (pn.filter = new pn("filter", { fontCharacter: "\\eaf1" })),
    (pn.flame = new pn("flame", { fontCharacter: "\\eaf2" })),
    (pn.foldDown = new pn("fold-down", { fontCharacter: "\\eaf3" })),
    (pn.foldUp = new pn("fold-up", { fontCharacter: "\\eaf4" })),
    (pn.fold = new pn("fold", { fontCharacter: "\\eaf5" })),
    (pn.folderActive = new pn("folder-active", { fontCharacter: "\\eaf6" })),
    (pn.folderOpened = new pn("folder-opened", { fontCharacter: "\\eaf7" })),
    (pn.gear = new pn("gear", { fontCharacter: "\\eaf8" })),
    (pn.gift = new pn("gift", { fontCharacter: "\\eaf9" })),
    (pn.gistSecret = new pn("gist-secret", { fontCharacter: "\\eafa" })),
    (pn.gist = new pn("gist", { fontCharacter: "\\eafb" })),
    (pn.gitCommit = new pn("git-commit", { fontCharacter: "\\eafc" })),
    (pn.gitCompare = new pn("git-compare", { fontCharacter: "\\eafd" })),
    (pn.gitMerge = new pn("git-merge", { fontCharacter: "\\eafe" })),
    (pn.githubAction = new pn("github-action", { fontCharacter: "\\eaff" })),
    (pn.githubAlt = new pn("github-alt", { fontCharacter: "\\eb00" })),
    (pn.globe = new pn("globe", { fontCharacter: "\\eb01" })),
    (pn.grabber = new pn("grabber", { fontCharacter: "\\eb02" })),
    (pn.graph = new pn("graph", { fontCharacter: "\\eb03" })),
    (pn.gripper = new pn("gripper", { fontCharacter: "\\eb04" })),
    (pn.heart = new pn("heart", { fontCharacter: "\\eb05" })),
    (pn.home = new pn("home", { fontCharacter: "\\eb06" })),
    (pn.horizontalRule = new pn("horizontal-rule", {
      fontCharacter: "\\eb07",
    })),
    (pn.hubot = new pn("hubot", { fontCharacter: "\\eb08" })),
    (pn.inbox = new pn("inbox", { fontCharacter: "\\eb09" })),
    (pn.issueClosed = new pn("issue-closed", { fontCharacter: "\\eba4" })),
    (pn.issueReopened = new pn("issue-reopened", { fontCharacter: "\\eb0b" })),
    (pn.issues = new pn("issues", { fontCharacter: "\\eb0c" })),
    (pn.italic = new pn("italic", { fontCharacter: "\\eb0d" })),
    (pn.jersey = new pn("jersey", { fontCharacter: "\\eb0e" })),
    (pn.json = new pn("json", { fontCharacter: "\\eb0f" })),
    (pn.kebabVertical = new pn("kebab-vertical", { fontCharacter: "\\eb10" })),
    (pn.key = new pn("key", { fontCharacter: "\\eb11" })),
    (pn.law = new pn("law", { fontCharacter: "\\eb12" })),
    (pn.lightbulbAutofix = new pn("lightbulb-autofix", {
      fontCharacter: "\\eb13",
    })),
    (pn.linkExternal = new pn("link-external", { fontCharacter: "\\eb14" })),
    (pn.link = new pn("link", { fontCharacter: "\\eb15" })),
    (pn.listOrdered = new pn("list-ordered", { fontCharacter: "\\eb16" })),
    (pn.listUnordered = new pn("list-unordered", { fontCharacter: "\\eb17" })),
    (pn.liveShare = new pn("live-share", { fontCharacter: "\\eb18" })),
    (pn.loading = new pn("loading", { fontCharacter: "\\eb19" })),
    (pn.location = new pn("location", { fontCharacter: "\\eb1a" })),
    (pn.mailRead = new pn("mail-read", { fontCharacter: "\\eb1b" })),
    (pn.mail = new pn("mail", { fontCharacter: "\\eb1c" })),
    (pn.markdown = new pn("markdown", { fontCharacter: "\\eb1d" })),
    (pn.megaphone = new pn("megaphone", { fontCharacter: "\\eb1e" })),
    (pn.mention = new pn("mention", { fontCharacter: "\\eb1f" })),
    (pn.milestone = new pn("milestone", { fontCharacter: "\\eb20" })),
    (pn.mortarBoard = new pn("mortar-board", { fontCharacter: "\\eb21" })),
    (pn.move = new pn("move", { fontCharacter: "\\eb22" })),
    (pn.multipleWindows = new pn("multiple-windows", {
      fontCharacter: "\\eb23",
    })),
    (pn.mute = new pn("mute", { fontCharacter: "\\eb24" })),
    (pn.noNewline = new pn("no-newline", { fontCharacter: "\\eb25" })),
    (pn.note = new pn("note", { fontCharacter: "\\eb26" })),
    (pn.octoface = new pn("octoface", { fontCharacter: "\\eb27" })),
    (pn.openPreview = new pn("open-preview", { fontCharacter: "\\eb28" })),
    (pn.package_ = new pn("package", { fontCharacter: "\\eb29" })),
    (pn.paintcan = new pn("paintcan", { fontCharacter: "\\eb2a" })),
    (pn.pin = new pn("pin", { fontCharacter: "\\eb2b" })),
    (pn.play = new pn("play", { fontCharacter: "\\eb2c" })),
    (pn.run = new pn("run", { fontCharacter: "\\eb2c" })),
    (pn.plug = new pn("plug", { fontCharacter: "\\eb2d" })),
    (pn.preserveCase = new pn("preserve-case", { fontCharacter: "\\eb2e" })),
    (pn.preview = new pn("preview", { fontCharacter: "\\eb2f" })),
    (pn.project = new pn("project", { fontCharacter: "\\eb30" })),
    (pn.pulse = new pn("pulse", { fontCharacter: "\\eb31" })),
    (pn.question = new pn("question", { fontCharacter: "\\eb32" })),
    (pn.quote = new pn("quote", { fontCharacter: "\\eb33" })),
    (pn.radioTower = new pn("radio-tower", { fontCharacter: "\\eb34" })),
    (pn.reactions = new pn("reactions", { fontCharacter: "\\eb35" })),
    (pn.references = new pn("references", { fontCharacter: "\\eb36" })),
    (pn.refresh = new pn("refresh", { fontCharacter: "\\eb37" })),
    (pn.regex = new pn("regex", { fontCharacter: "\\eb38" })),
    (pn.remoteExplorer = new pn("remote-explorer", {
      fontCharacter: "\\eb39",
    })),
    (pn.remote = new pn("remote", { fontCharacter: "\\eb3a" })),
    (pn.remove = new pn("remove", { fontCharacter: "\\eb3b" })),
    (pn.replaceAll = new pn("replace-all", { fontCharacter: "\\eb3c" })),
    (pn.replace = new pn("replace", { fontCharacter: "\\eb3d" })),
    (pn.repoClone = new pn("repo-clone", { fontCharacter: "\\eb3e" })),
    (pn.repoForcePush = new pn("repo-force-push", { fontCharacter: "\\eb3f" })),
    (pn.repoPull = new pn("repo-pull", { fontCharacter: "\\eb40" })),
    (pn.repoPush = new pn("repo-push", { fontCharacter: "\\eb41" })),
    (pn.report = new pn("report", { fontCharacter: "\\eb42" })),
    (pn.requestChanges = new pn("request-changes", {
      fontCharacter: "\\eb43",
    })),
    (pn.rocket = new pn("rocket", { fontCharacter: "\\eb44" })),
    (pn.rootFolderOpened = new pn("root-folder-opened", {
      fontCharacter: "\\eb45",
    })),
    (pn.rootFolder = new pn("root-folder", { fontCharacter: "\\eb46" })),
    (pn.rss = new pn("rss", { fontCharacter: "\\eb47" })),
    (pn.ruby = new pn("ruby", { fontCharacter: "\\eb48" })),
    (pn.saveAll = new pn("save-all", { fontCharacter: "\\eb49" })),
    (pn.saveAs = new pn("save-as", { fontCharacter: "\\eb4a" })),
    (pn.save = new pn("save", { fontCharacter: "\\eb4b" })),
    (pn.screenFull = new pn("screen-full", { fontCharacter: "\\eb4c" })),
    (pn.screenNormal = new pn("screen-normal", { fontCharacter: "\\eb4d" })),
    (pn.searchStop = new pn("search-stop", { fontCharacter: "\\eb4e" })),
    (pn.server = new pn("server", { fontCharacter: "\\eb50" })),
    (pn.settingsGear = new pn("settings-gear", { fontCharacter: "\\eb51" })),
    (pn.settings = new pn("settings", { fontCharacter: "\\eb52" })),
    (pn.shield = new pn("shield", { fontCharacter: "\\eb53" })),
    (pn.smiley = new pn("smiley", { fontCharacter: "\\eb54" })),
    (pn.sortPrecedence = new pn("sort-precedence", {
      fontCharacter: "\\eb55",
    })),
    (pn.splitHorizontal = new pn("split-horizontal", {
      fontCharacter: "\\eb56",
    })),
    (pn.splitVertical = new pn("split-vertical", { fontCharacter: "\\eb57" })),
    (pn.squirrel = new pn("squirrel", { fontCharacter: "\\eb58" })),
    (pn.starFull = new pn("star-full", { fontCharacter: "\\eb59" })),
    (pn.starHalf = new pn("star-half", { fontCharacter: "\\eb5a" })),
    (pn.symbolClass = new pn("symbol-class", { fontCharacter: "\\eb5b" })),
    (pn.symbolColor = new pn("symbol-color", { fontCharacter: "\\eb5c" })),
    (pn.symbolCustomColor = new pn("symbol-customcolor", {
      fontCharacter: "\\eb5c",
    })),
    (pn.symbolConstant = new pn("symbol-constant", {
      fontCharacter: "\\eb5d",
    })),
    (pn.symbolEnumMember = new pn("symbol-enum-member", {
      fontCharacter: "\\eb5e",
    })),
    (pn.symbolField = new pn("symbol-field", { fontCharacter: "\\eb5f" })),
    (pn.symbolFile = new pn("symbol-file", { fontCharacter: "\\eb60" })),
    (pn.symbolInterface = new pn("symbol-interface", {
      fontCharacter: "\\eb61",
    })),
    (pn.symbolKeyword = new pn("symbol-keyword", { fontCharacter: "\\eb62" })),
    (pn.symbolMisc = new pn("symbol-misc", { fontCharacter: "\\eb63" })),
    (pn.symbolOperator = new pn("symbol-operator", {
      fontCharacter: "\\eb64",
    })),
    (pn.symbolProperty = new pn("symbol-property", {
      fontCharacter: "\\eb65",
    })),
    (pn.wrench = new pn("wrench", { fontCharacter: "\\eb65" })),
    (pn.wrenchSubaction = new pn("wrench-subaction", {
      fontCharacter: "\\eb65",
    })),
    (pn.symbolSnippet = new pn("symbol-snippet", { fontCharacter: "\\eb66" })),
    (pn.tasklist = new pn("tasklist", { fontCharacter: "\\eb67" })),
    (pn.telescope = new pn("telescope", { fontCharacter: "\\eb68" })),
    (pn.textSize = new pn("text-size", { fontCharacter: "\\eb69" })),
    (pn.threeBars = new pn("three-bars", { fontCharacter: "\\eb6a" })),
    (pn.thumbsdown = new pn("thumbsdown", { fontCharacter: "\\eb6b" })),
    (pn.thumbsup = new pn("thumbsup", { fontCharacter: "\\eb6c" })),
    (pn.tools = new pn("tools", { fontCharacter: "\\eb6d" })),
    (pn.triangleDown = new pn("triangle-down", { fontCharacter: "\\eb6e" })),
    (pn.triangleLeft = new pn("triangle-left", { fontCharacter: "\\eb6f" })),
    (pn.triangleRight = new pn("triangle-right", { fontCharacter: "\\eb70" })),
    (pn.triangleUp = new pn("triangle-up", { fontCharacter: "\\eb71" })),
    (pn.twitter = new pn("twitter", { fontCharacter: "\\eb72" })),
    (pn.unfold = new pn("unfold", { fontCharacter: "\\eb73" })),
    (pn.unlock = new pn("unlock", { fontCharacter: "\\eb74" })),
    (pn.unmute = new pn("unmute", { fontCharacter: "\\eb75" })),
    (pn.unverified = new pn("unverified", { fontCharacter: "\\eb76" })),
    (pn.verified = new pn("verified", { fontCharacter: "\\eb77" })),
    (pn.versions = new pn("versions", { fontCharacter: "\\eb78" })),
    (pn.vmActive = new pn("vm-active", { fontCharacter: "\\eb79" })),
    (pn.vmOutline = new pn("vm-outline", { fontCharacter: "\\eb7a" })),
    (pn.vmRunning = new pn("vm-running", { fontCharacter: "\\eb7b" })),
    (pn.watch = new pn("watch", { fontCharacter: "\\eb7c" })),
    (pn.whitespace = new pn("whitespace", { fontCharacter: "\\eb7d" })),
    (pn.wholeWord = new pn("whole-word", { fontCharacter: "\\eb7e" })),
    (pn.window = new pn("window", { fontCharacter: "\\eb7f" })),
    (pn.wordWrap = new pn("word-wrap", { fontCharacter: "\\eb80" })),
    (pn.zoomIn = new pn("zoom-in", { fontCharacter: "\\eb81" })),
    (pn.zoomOut = new pn("zoom-out", { fontCharacter: "\\eb82" })),
    (pn.listFilter = new pn("list-filter", { fontCharacter: "\\eb83" })),
    (pn.listFlat = new pn("list-flat", { fontCharacter: "\\eb84" })),
    (pn.listSelection = new pn("list-selection", { fontCharacter: "\\eb85" })),
    (pn.selection = new pn("selection", { fontCharacter: "\\eb85" })),
    (pn.listTree = new pn("list-tree", { fontCharacter: "\\eb86" })),
    (pn.debugBreakpointFunctionUnverified = new pn(
      "debug-breakpoint-function-unverified",
      { fontCharacter: "\\eb87" },
    )),
    (pn.debugBreakpointFunction = new pn("debug-breakpoint-function", {
      fontCharacter: "\\eb88",
    })),
    (pn.debugBreakpointFunctionDisabled = new pn(
      "debug-breakpoint-function-disabled",
      { fontCharacter: "\\eb88" },
    )),
    (pn.debugStackframeActive = new pn("debug-stackframe-active", {
      fontCharacter: "\\eb89",
    })),
    (pn.circleSmallFilled = new pn("circle-small-filled", {
      fontCharacter: "\\eb8a",
    })),
    (pn.debugStackframeDot = new pn(
      "debug-stackframe-dot",
      pn.circleSmallFilled.definition,
    )),
    (pn.debugStackframe = new pn("debug-stackframe", {
      fontCharacter: "\\eb8b",
    })),
    (pn.debugStackframeFocused = new pn("debug-stackframe-focused", {
      fontCharacter: "\\eb8b",
    })),
    (pn.debugBreakpointUnsupported = new pn("debug-breakpoint-unsupported", {
      fontCharacter: "\\eb8c",
    })),
    (pn.symbolString = new pn("symbol-string", { fontCharacter: "\\eb8d" })),
    (pn.debugReverseContinue = new pn("debug-reverse-continue", {
      fontCharacter: "\\eb8e",
    })),
    (pn.debugStepBack = new pn("debug-step-back", { fontCharacter: "\\eb8f" })),
    (pn.debugRestartFrame = new pn("debug-restart-frame", {
      fontCharacter: "\\eb90",
    })),
    (pn.callIncoming = new pn("call-incoming", { fontCharacter: "\\eb92" })),
    (pn.callOutgoing = new pn("call-outgoing", { fontCharacter: "\\eb93" })),
    (pn.menu = new pn("menu", { fontCharacter: "\\eb94" })),
    (pn.expandAll = new pn("expand-all", { fontCharacter: "\\eb95" })),
    (pn.feedback = new pn("feedback", { fontCharacter: "\\eb96" })),
    (pn.groupByRefType = new pn("group-by-ref-type", {
      fontCharacter: "\\eb97",
    })),
    (pn.ungroupByRefType = new pn("ungroup-by-ref-type", {
      fontCharacter: "\\eb98",
    })),
    (pn.account = new pn("account", { fontCharacter: "\\eb99" })),
    (pn.bellDot = new pn("bell-dot", { fontCharacter: "\\eb9a" })),
    (pn.debugConsole = new pn("debug-console", { fontCharacter: "\\eb9b" })),
    (pn.library = new pn("library", { fontCharacter: "\\eb9c" })),
    (pn.output = new pn("output", { fontCharacter: "\\eb9d" })),
    (pn.runAll = new pn("run-all", { fontCharacter: "\\eb9e" })),
    (pn.syncIgnored = new pn("sync-ignored", { fontCharacter: "\\eb9f" })),
    (pn.pinned = new pn("pinned", { fontCharacter: "\\eba0" })),
    (pn.githubInverted = new pn("github-inverted", {
      fontCharacter: "\\eba1",
    })),
    (pn.debugAlt = new pn("debug-alt", { fontCharacter: "\\eb91" })),
    (pn.serverProcess = new pn("server-process", { fontCharacter: "\\eba2" })),
    (pn.serverEnvironment = new pn("server-environment", {
      fontCharacter: "\\eba3",
    })),
    (pn.pass = new pn("pass", { fontCharacter: "\\eba4" })),
    (pn.stopCircle = new pn("stop-circle", { fontCharacter: "\\eba5" })),
    (pn.playCircle = new pn("play-circle", { fontCharacter: "\\eba6" })),
    (pn.record = new pn("record", { fontCharacter: "\\eba7" })),
    (pn.debugAltSmall = new pn("debug-alt-small", { fontCharacter: "\\eba8" })),
    (pn.vmConnect = new pn("vm-connect", { fontCharacter: "\\eba9" })),
    (pn.cloud = new pn("cloud", { fontCharacter: "\\ebaa" })),
    (pn.merge = new pn("merge", { fontCharacter: "\\ebab" })),
    (pn.exportIcon = new pn("export", { fontCharacter: "\\ebac" })),
    (pn.graphLeft = new pn("graph-left", { fontCharacter: "\\ebad" })),
    (pn.magnet = new pn("magnet", { fontCharacter: "\\ebae" })),
    (pn.notebook = new pn("notebook", { fontCharacter: "\\ebaf" })),
    (pn.redo = new pn("redo", { fontCharacter: "\\ebb0" })),
    (pn.checkAll = new pn("check-all", { fontCharacter: "\\ebb1" })),
    (pn.pinnedDirty = new pn("pinned-dirty", { fontCharacter: "\\ebb2" })),
    (pn.passFilled = new pn("pass-filled", { fontCharacter: "\\ebb3" })),
    (pn.circleLargeFilled = new pn("circle-large-filled", {
      fontCharacter: "\\ebb4",
    })),
    (pn.circleLargeOutline = new pn("circle-large-outline", {
      fontCharacter: "\\ebb5",
    })),
    (pn.combine = new pn("combine", { fontCharacter: "\\ebb6" })),
    (pn.gather = new pn("gather", { fontCharacter: "\\ebb6" })),
    (pn.table = new pn("table", { fontCharacter: "\\ebb7" })),
    (pn.variableGroup = new pn("variable-group", { fontCharacter: "\\ebb8" })),
    (pn.typeHierarchy = new pn("type-hierarchy", { fontCharacter: "\\ebb9" })),
    (pn.typeHierarchySub = new pn("type-hierarchy-sub", {
      fontCharacter: "\\ebba",
    })),
    (pn.typeHierarchySuper = new pn("type-hierarchy-super", {
      fontCharacter: "\\ebbb",
    })),
    (pn.gitPullRequestCreate = new pn("git-pull-request-create", {
      fontCharacter: "\\ebbc",
    })),
    (pn.runAbove = new pn("run-above", { fontCharacter: "\\ebbd" })),
    (pn.runBelow = new pn("run-below", { fontCharacter: "\\ebbe" })),
    (pn.notebookTemplate = new pn("notebook-template", {
      fontCharacter: "\\ebbf",
    })),
    (pn.debugRerun = new pn("debug-rerun", { fontCharacter: "\\ebc0" })),
    (pn.workspaceTrusted = new pn("workspace-trusted", {
      fontCharacter: "\\ebc1",
    })),
    (pn.workspaceUntrusted = new pn("workspace-untrusted", {
      fontCharacter: "\\ebc2",
    })),
    (pn.workspaceUnspecified = new pn("workspace-unspecified", {
      fontCharacter: "\\ebc3",
    })),
    (pn.terminalCmd = new pn("terminal-cmd", { fontCharacter: "\\ebc4" })),
    (pn.terminalDebian = new pn("terminal-debian", {
      fontCharacter: "\\ebc5",
    })),
    (pn.terminalLinux = new pn("terminal-linux", { fontCharacter: "\\ebc6" })),
    (pn.terminalPowershell = new pn("terminal-powershell", {
      fontCharacter: "\\ebc7",
    })),
    (pn.terminalTmux = new pn("terminal-tmux", { fontCharacter: "\\ebc8" })),
    (pn.terminalUbuntu = new pn("terminal-ubuntu", {
      fontCharacter: "\\ebc9",
    })),
    (pn.terminalBash = new pn("terminal-bash", { fontCharacter: "\\ebca" })),
    (pn.arrowSwap = new pn("arrow-swap", { fontCharacter: "\\ebcb" })),
    (pn.copy = new pn("copy", { fontCharacter: "\\ebcc" })),
    (pn.personAdd = new pn("person-add", { fontCharacter: "\\ebcd" })),
    (pn.filterFilled = new pn("filter-filled", { fontCharacter: "\\ebce" })),
    (pn.wand = new pn("wand", { fontCharacter: "\\ebcf" })),
    (pn.debugLineByLine = new pn("debug-line-by-line", {
      fontCharacter: "\\ebd0",
    })),
    (pn.inspect = new pn("inspect", { fontCharacter: "\\ebd1" })),
    (pn.layers = new pn("layers", { fontCharacter: "\\ebd2" })),
    (pn.layersDot = new pn("layers-dot", { fontCharacter: "\\ebd3" })),
    (pn.layersActive = new pn("layers-active", { fontCharacter: "\\ebd4" })),
    (pn.compass = new pn("compass", { fontCharacter: "\\ebd5" })),
    (pn.compassDot = new pn("compass-dot", { fontCharacter: "\\ebd6" })),
    (pn.compassActive = new pn("compass-active", { fontCharacter: "\\ebd7" })),
    (pn.azure = new pn("azure", { fontCharacter: "\\ebd8" })),
    (pn.issueDraft = new pn("issue-draft", { fontCharacter: "\\ebd9" })),
    (pn.gitPullRequestClosed = new pn("git-pull-request-closed", {
      fontCharacter: "\\ebda",
    })),
    (pn.gitPullRequestDraft = new pn("git-pull-request-draft", {
      fontCharacter: "\\ebdb",
    })),
    (pn.debugAll = new pn("debug-all", { fontCharacter: "\\ebdc" })),
    (pn.debugCoverage = new pn("debug-coverage", { fontCharacter: "\\ebdd" })),
    (pn.runErrors = new pn("run-errors", { fontCharacter: "\\ebde" })),
    (pn.folderLibrary = new pn("folder-library", { fontCharacter: "\\ebdf" })),
    (pn.debugContinueSmall = new pn("debug-continue-small", {
      fontCharacter: "\\ebe0",
    })),
    (pn.beakerStop = new pn("beaker-stop", { fontCharacter: "\\ebe1" })),
    (pn.graphLine = new pn("graph-line", { fontCharacter: "\\ebe2" })),
    (pn.graphScatter = new pn("graph-scatter", { fontCharacter: "\\ebe3" })),
    (pn.pieChart = new pn("pie-chart", { fontCharacter: "\\ebe4" })),
    (pn.bracket = new pn("bracket", pn.json.definition)),
    (pn.bracketDot = new pn("bracket-dot", { fontCharacter: "\\ebe5" })),
    (pn.bracketError = new pn("bracket-error", { fontCharacter: "\\ebe6" })),
    (pn.lockSmall = new pn("lock-small", { fontCharacter: "\\ebe7" })),
    (pn.azureDevops = new pn("azure-devops", { fontCharacter: "\\ebe8" })),
    (pn.verifiedFilled = new pn("verified-filled", {
      fontCharacter: "\\ebe9",
    })),
    (pn.newLine = new pn("newline", { fontCharacter: "\\ebea" })),
    (pn.layout = new pn("layout", { fontCharacter: "\\ebeb" })),
    (pn.layoutActivitybarLeft = new pn("layout-activitybar-left", {
      fontCharacter: "\\ebec",
    })),
    (pn.layoutActivitybarRight = new pn("layout-activitybar-right", {
      fontCharacter: "\\ebed",
    })),
    (pn.layoutPanelLeft = new pn("layout-panel-left", {
      fontCharacter: "\\ebee",
    })),
    (pn.layoutPanelCenter = new pn("layout-panel-center", {
      fontCharacter: "\\ebef",
    })),
    (pn.layoutPanelJustify = new pn("layout-panel-justify", {
      fontCharacter: "\\ebf0",
    })),
    (pn.layoutPanelRight = new pn("layout-panel-right", {
      fontCharacter: "\\ebf1",
    })),
    (pn.layoutPanel = new pn("layout-panel", { fontCharacter: "\\ebf2" })),
    (pn.layoutSidebarLeft = new pn("layout-sidebar-left", {
      fontCharacter: "\\ebf3",
    })),
    (pn.layoutSidebarRight = new pn("layout-sidebar-right", {
      fontCharacter: "\\ebf4",
    })),
    (pn.layoutStatusbar = new pn("layout-statusbar", {
      fontCharacter: "\\ebf5",
    })),
    (pn.layoutMenubar = new pn("layout-menubar", { fontCharacter: "\\ebf6" })),
    (pn.layoutCentered = new pn("layout-centered", {
      fontCharacter: "\\ebf7",
    })),
    (pn.layoutSidebarRightOff = new pn("layout-sidebar-right-off", {
      fontCharacter: "\\ec00",
    })),
    (pn.layoutPanelOff = new pn("layout-panel-off", {
      fontCharacter: "\\ec01",
    })),
    (pn.layoutSidebarLeftOff = new pn("layout-sidebar-left-off", {
      fontCharacter: "\\ec02",
    })),
    (pn.target = new pn("target", { fontCharacter: "\\ebf8" })),
    (pn.indent = new pn("indent", { fontCharacter: "\\ebf9" })),
    (pn.recordSmall = new pn("record-small", { fontCharacter: "\\ebfa" })),
    (pn.errorSmall = new pn("error-small", { fontCharacter: "\\ebfb" })),
    (pn.arrowCircleDown = new pn("arrow-circle-down", {
      fontCharacter: "\\ebfc",
    })),
    (pn.arrowCircleLeft = new pn("arrow-circle-left", {
      fontCharacter: "\\ebfd",
    })),
    (pn.arrowCircleRight = new pn("arrow-circle-right", {
      fontCharacter: "\\ebfe",
    })),
    (pn.arrowCircleUp = new pn("arrow-circle-up", { fontCharacter: "\\ebff" })),
    (pn.heartFilled = new pn("heart-filled", { fontCharacter: "\\ec04" })),
    (pn.map = new pn("map", { fontCharacter: "\\ec05" })),
    (pn.mapFilled = new pn("map-filled", { fontCharacter: "\\ec06" })),
    (pn.circleSmall = new pn("circle-small", { fontCharacter: "\\ec07" })),
    (pn.bellSlash = new pn("bell-slash", { fontCharacter: "\\ec08" })),
    (pn.bellSlashDot = new pn("bell-slash-dot", { fontCharacter: "\\ec09" })),
    (pn.commentUnresolved = new pn("comment-unresolved", {
      fontCharacter: "\\ec0a",
    })),
    (pn.gitPullRequestGoToChanges = new pn("git-pull-request-go-to-changes", {
      fontCharacter: "\\ec0b",
    })),
    (pn.gitPullRequestNewChanges = new pn("git-pull-request-new-changes", {
      fontCharacter: "\\ec0c",
    })),
    (pn.dialogError = new pn("dialog-error", pn.error.definition)),
    (pn.dialogWarning = new pn("dialog-warning", pn.warning.definition)),
    (pn.dialogInfo = new pn("dialog-info", pn.info.definition)),
    (pn.dialogClose = new pn("dialog-close", pn.close.definition)),
    (pn.treeItemExpanded = new pn(
      "tree-item-expanded",
      pn.chevronDown.definition,
    )),
    (pn.treeFilterOnTypeOn = new pn(
      "tree-filter-on-type-on",
      pn.listFilter.definition,
    )),
    (pn.treeFilterOnTypeOff = new pn(
      "tree-filter-on-type-off",
      pn.listSelection.definition,
    )),
    (pn.treeFilterClear = new pn("tree-filter-clear", pn.close.definition)),
    (pn.treeItemLoading = new pn("tree-item-loading", pn.loading.definition)),
    (pn.menuSelection = new pn("menu-selection", pn.check.definition)),
    (pn.menuSubmenu = new pn("menu-submenu", pn.chevronRight.definition)),
    (pn.menuBarMore = new pn("menubar-more", pn.more.definition)),
    (pn.scrollbarButtonLeft = new pn(
      "scrollbar-button-left",
      pn.triangleLeft.definition,
    )),
    (pn.scrollbarButtonRight = new pn(
      "scrollbar-button-right",
      pn.triangleRight.definition,
    )),
    (pn.scrollbarButtonUp = new pn(
      "scrollbar-button-up",
      pn.triangleUp.definition,
    )),
    (pn.scrollbarButtonDown = new pn(
      "scrollbar-button-down",
      pn.triangleDown.definition,
    )),
    (pn.toolBarMore = new pn("toolbar-more", pn.more.definition)),
    (pn.quickInputBack = new pn("quick-input-back", pn.arrowLeft.definition)),
    (function (e) {
      ...
      function n(e) {
        if (e instanceof pn) return ["codicon", "codicon-" + e.id];
        const r = t.exec(e.id);
        if (!r) return n(pn.error);
        const [, i, o] = r,
          a = ["codicon", "codicon-" + i];
  ...
  !(function (e) {
    const t = new Map();
    t.set(0, pn.symbolMethod),
      t.set(1, pn.symbolFunction),
      t.set(2, pn.symbolConstructor),
      t.set(3, pn.symbolField),
      t.set(4, pn.symbolVariable),
      t.set(5, pn.symbolClass),
      t.set(6, pn.symbolStruct),
      t.set(7, pn.symbolInterface),
      t.set(8, pn.symbolModule),
      t.set(9, pn.symbolProperty),
      t.set(10, pn.symbolEvent),
      t.set(11, pn.symbolOperator),
      t.set(12, pn.symbolUnit),
      t.set(13, pn.symbolValue),
      t.set(15, pn.symbolEnum),
      t.set(14, pn.symbolConstant),
      t.set(15, pn.symbolEnum),
      t.set(16, pn.symbolEnumMember),
      t.set(17, pn.symbolKeyword),
      t.set(27, pn.symbolSnippet),
      t.set(18, pn.symbolText),
      t.set(19, pn.symbolColor),
      t.set(20, pn.symbolFile),
      t.set(21, pn.symbolReference),
      t.set(22, pn.symbolCustomColor),
      t.set(23, pn.symbolFolder),
      t.set(24, pn.symbolTypeParameter),
      t.set(25, pn.account),
      t.set(26, pn.issues),
      (e.toIcon = function (e) {
        let n = t.get(e);
    ...
    (function (e) {
      const t = new Map();
      t.set(0, pn.symbolFile),
        t.set(1, pn.symbolModule),
        t.set(2, pn.symbolNamespace),
        t.set(3, pn.symbolPackage),
        t.set(4, pn.symbolClass),
        t.set(5, pn.symbolMethod),
        t.set(6, pn.symbolProperty),
        t.set(7, pn.symbolField),
        t.set(8, pn.symbolConstructor),
        t.set(9, pn.symbolEnum),
        t.set(10, pn.symbolInterface),
        t.set(11, pn.symbolFunction),
        t.set(12, pn.symbolVariable),
        t.set(13, pn.symbolConstant),
        t.set(14, pn.symbolString),
        t.set(15, pn.symbolNumber),
        t.set(16, pn.symbolBoolean),
        t.set(17, pn.symbolArray),
        t.set(18, pn.symbolObject),
        t.set(19, pn.symbolKey),
        t.set(20, pn.symbolNull),
        t.set(21, pn.symbolEnumMember),
        t.set(22, pn.symbolStruct),
        t.set(23, pn.symbolEvent),
        t.set(24, pn.symbolOperator),
        t.set(25, pn.symbolTypeParameter),
        (e.toIcon = function (e) {
          let n = t.get(e);
          return (
            n ||
  ...
  (Rn.Comment = new Rn("comment")),
    (Rn.Imports = new Rn("imports")),
    (Rn.Region = new Rn("region")),
    (function (e) {
      e.is = function (e) {
        return (
          !(!e || "object" !== typeof e) &&
  ...
  !(function (e) {
    ...
    (function (e) {
      (e[(e.acceptSuggestionOnCommitCharacter = 0)] =
        ...
        (e[(e.dropIntoEditor = 32)] = "dropIntoEditor"),
        (e[(e.emptySelectionClipboard = 33)] = "emptySelectionClipboard"),
        (e[(e.experimental = 34)] = "experimental"),
        (e[(e.extraEditorClassName = 35)] = "extraEditorClassName"),
        (e[(e.fastScrollSensitivity = 36)] = "fastScrollSensitivity"),
        (e[(e.find = 37)] = "find"),
        (e[(e.fixedOverflowWidgets = 38)] = "fixedOverflowWidgets"),
        (e[(e.folding = 39)] = "folding"),
        (e[(e.foldingStrategy = 40)] = "foldingStrategy"),
        (e[(e.foldingHighlight = 41)] = "foldingHighlight"),
        (e[(e.foldingImportsByDefault = 42)] = "foldingImportsByDefault"),
        (e[(e.foldingMaximumRegions = 43)] = "foldingMaximumRegions"),
        (e[(e.unfoldOnClickAfterEndOfLine = 44)] =
          "unfoldOnClickAfterEndOfLine"),
        (e[(e.fontFamily = 45)] = "fontFamily"),
        (e[(e.fontInfo = 46)] = "fontInfo"),
        (e[(e.fontLigatures = 47)] = "fontLigatures"),
        (e[(e.fontSize = 48)] = "fontSize"),
        (e[(e.fontWeight = 49)] = "fontWeight"),
        (e[(e.formatOnPaste = 50)] = "formatOnPaste"),
        (e[(e.formatOnType = 51)] = "formatOnType"),
        (e[(e.glyphMargin = 52)] = "glyphMargin"),
        (e[(e.gotoLocation = 53)] = "gotoLocation"),
        (e[(e.hideCursorInOverviewRuler = 54)] = "hideCursorInOverviewRuler"),
        (e[(e.hover = 55)] = "hover"),
        (e[(e.inDiffEditor = 56)] = "inDiffEditor"),
        (e[(e.inlineSuggest = 57)] = "inlineSuggest"),
        (e[(e.letterSpacing = 58)] = "letterSpacing"),
        (e[(e.lightbulb = 59)] = "lightbulb"),
        (e[(e.lineDecorationsWidth = 60)] = "lineDecorationsWidth"),
        (e[(e.lineHeight = 61)] = "lineHeight"),
        (e[(e.lineNumbers = 62)] = "lineNumbers"),
        (e[(e.lineNumbersMinChars = 63)] = "lineNumbersMinChars"),
        (e[(e.linkedEditing = 64)] = "linkedEditing"),
        (e[(e.links = 65)] = "links"),
        (e[(e.matchBrackets = 66)] = "matchBrackets"),
        (e[(e.minimap = 67)] = "minimap"),
        (e[(e.mouseStyle = 68)] = "mouseStyle"),
        (e[(e.mouseWheelScrollSensitivity = 69)] =
          "mouseWheelScrollSensitivity"),
        (e[(e.mouseWheelZoom = 70)] = "mouseWheelZoom"),
        (e[(e.multiCursorMergeOverlapping = 71)] =
          "multiCursorMergeOverlapping"),
        (e[(e.multiCursorModifier = 72)] = "multiCursorModifier"),
        (e[(e.multiCursorPaste = 73)] = "multiCursorPaste"),
        (e[(e.occurrencesHighlight = 74)] = "occurrencesHighlight"),
        (e[(e.overviewRulerBorder = 75)] = "overviewRulerBorder"),
        (e[(e.overviewRulerLanes = 76)] = "overviewRulerLanes"),
        (e[(e.padding = 77)] = "padding"),
        (e[(e.parameterHints = 78)] = "parameterHints"),
        (e[(e.peekWidgetDefaultFocus = 79)] = "peekWidgetDefaultFocus"),
        (e[(e.definitionLinkOpensInPeek = 80)] = "definitionLinkOpensInPeek"),
        (e[(e.quickSuggestions = 81)] = "quickSuggestions"),
        (e[(e.quickSuggestionsDelay = 82)] = "quickSuggestionsDelay"),
        (e[(e.readOnly = 83)] = "readOnly"),
        (e[(e.renameOnType = 84)] = "renameOnType"),
        (e[(e.renderControlCharacters = 85)] = "renderControlCharacters"),
        (e[(e.renderFinalNewline = 86)] = "renderFinalNewline"),
        (e[(e.renderLineHighlight = 87)] = "renderLineHighlight"),
        (e[(e.renderLineHighlightOnlyWhenFocus = 88)] =
          "renderLineHighlightOnlyWhenFocus"),
        (e[(e.renderValidationDecorations = 89)] =
          "renderValidationDecorations"),
        (e[(e.renderWhitespace = 90)] = "renderWhitespace"),
        (e[(e.revealHorizontalRightPadding = 91)] =
          "revealHorizontalRightPadding"),
        (e[(e.roundedSelection = 92)] = "roundedSelection"),
        (e[(e.rulers = 93)] = "rulers"),
        (e[(e.scrollbar = 94)] = "scrollbar"),
        (e[(e.scrollBeyondLastColumn = 95)] = "scrollBeyondLastColumn"),
        (e[(e.scrollBeyondLastLine = 96)] = "scrollBeyondLastLine"),
        (e[(e.scrollPredominantAxis = 97)] = "scrollPredominantAxis"),
        (e[(e.selectionClipboard = 98)] = "selectionClipboard"),
        (e[(e.selectionHighlight = 99)] = "selectionHighlight"),
        (e[(e.selectOnLineNumbers = 100)] = "selectOnLineNumbers"),
        (e[(e.showFoldingControls = 101)] = "showFoldingControls"),
        (e[(e.showUnused = 102)] = "showUnused"),
        (e[(e.snippetSuggestions = 103)] = "snippetSuggestions"),
        (e[(e.smartSelect = 104)] = "smartSelect"),
        (e[(e.smoothScrolling = 105)] = "smoothScrolling"),
        (e[(e.stickyTabStops = 106)] = "stickyTabStops"),
        (e[(e.stopRenderingLineAfter = 107)] = "stopRenderingLineAfter"),
        (e[(e.suggest = 108)] = "suggest"),
        (e[(e.suggestFontSize = 109)] = "suggestFontSize"),
        (e[(e.suggestLineHeight = 110)] = "suggestLineHeight"),
        (e[(e.suggestOnTriggerCharacters = 111)] =
          "suggestOnTriggerCharacters"),
        (e[(e.suggestSelection = 112)] = "suggestSelection"),
        (e[(e.tabCompletion = 113)] = "tabCompletion"),
        (e[(e.tabIndex = 114)] = "tabIndex"),
        (e[(e.unicodeHighlighting = 115)] = "unicodeHighlighting"),
        (e[(e.unusualLineTerminators = 116)] = "unusualLineTerminators"),
        (e[(e.useShadowDOM = 117)] = "useShadowDOM"),
        (e[(e.useTabStops = 118)] = "useTabStops"),
        (e[(e.wordSeparators = 119)] = "wordSeparators"),
        (e[(e.wordWrap = 120)] = "wordWrap"),
        (e[(e.wordWrapBreakAfterCharacters = 121)] =
          "wordWrapBreakAfterCharacters"),
        (e[(e.wordWrapBreakBeforeCharacters = 122)] =
          "wordWrapBreakBeforeCharacters"),
        (e[(e.wordWrapColumn = 123)] = "wordWrapColumn"),
        (e[(e.wordWrapOverride1 = 124)] = "wordWrapOverride1"),
        (e[(e.wordWrapOverride2 = 125)] = "wordWrapOverride2"),
        (e[(e.wrappingIndent = 126)] = "wrappingIndent"),
        (e[(e.wrappingStrategy = 127)] = "wrappingStrategy"),
        (e[(e.showDeprecated = 128)] = "showDeprecated"),
        (e[(e.inlayHints = 129)] = "inlayHints"),
        (e[(e.editorClassName = 130)] = "editorClassName"),
        (e[(e.pixelRatio = 131)] = "pixelRatio"),
        (e[(e.tabFocusMode = 132)] = "tabFocusMode"),
        (e[(e.layoutInfo = 133)] = "layoutInfo"),
        (e[(e.wrappingInfo = 134)] = "wrappingInfo");
    })(Un || (Un = {})),
    (function (e) {
  ...
  (mr.CtrlCmd = 2048), (mr.Shift = 1024), (mr.Alt = 512), (mr.WinCtrl = 256);
  class gr extends jt {
    constructor(e) {
      super(0);
    ...
    next(e) {
      ...
      do {
        ...
        if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
          if (0 === i) {
            be(e, t, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || wr(this._wordSeparators, e, t, r, i))
        )
          return n;
      } while (n);
      return null;
        ...
        "allNonBasicAscii" === a
          ...
          : new RegExp(
              "".concat(
                ((l = Array.from(a)),
                "[".concat(
                  ue(l.map((e) => String.fromCodePoint(e)).join("")),
                  "]",
                )),
              ),
              "g",
            );
      const c = new _r(null, s),
        h = [];
      let u,
        d = !1,
        f = 0,
        m = 0,
        g = 0;
      e: for (let b = r, C = i; b <= C; b++) {
        const t = e.getLineContent(b),
          n = t.length;
        c.reset(0);
        do {
          if (((u = c.next(t)), u)) {
            ...
            if (e > 0) {
              fe(t.charCodeAt(e - 1)) && e--;
            }
            if (r + 1 < n) {
              fe(t.charCodeAt(r - 1)) && r++;
            }
            const i = t.substring(e, r),
              a = Wt(e + 1, qt, t, 0),
              s = o.shouldHighlightNonBasicASCII(i, a ? a.word : null);
            if (0 !== s) {
              3 === s ? f++ : 2 === s ? m++ : 1 === s ? g++ : le(s);
              const t = 1e3;
              if (h.length >= t) {
                d = !0;
                break e;
              }
              h.push(new Et(b, e + 1, b, r + 1));
            }
          }
        } while (u);
      }
  ...
  class Sr {
    constructor(e) {
      (this.options = e),
        ...
        (this.ambiguousCharacters = we.getInstance(new Set(e.allowedLocales)));
    }
    getCandidateCodePoints() {
      if (this.options.nonBasicASCII) return "allNonBasicAscii";
      const e = new Set();
      if (this.options.invisibleCharacters)
        for (const t of _e.codePoints) vr(String.fromCodePoint(t)) || e.add(t);
  ...
  class Nr extends Ut {
    ...
    getWordAtPosition(e, t) {
      ...
      return n
        ? new Et(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
        : null;
    }
    words(e) {
      const t = this._lines,
    ...
    _validatePosition(e) {
      if (!Nt.isIPosition(e)) throw new Error("bad position");
  ...
  class Er {
    ...
    computeUnicodeHighlights(e, t, n) {
      return Lr(this, void 0, void 0, function* () {
        ...
        return r
          ? yr.computeUnicodeHighlights(r, t, n)
          : {
              ranges: [],
              hasMore: !1,
    ...
    computeDiff(e, t, n, r) {
      return Lr(this, void 0, void 0, function* () {
        const i = this._getModel(e),
          o = this._getModel(t);
        return i && o ? Er.computeDiff(i, o, n, r) : null;
      });
    }
    static computeDiff(e, t, n, r) {
      ...
      return { quitEarly: a.quitEarly, identical: s, changes: a.changes };
    }
    ...
    computeMoreMinimalEdits(e, t) {
      return Lr(this, void 0, void 0, function* () {
        ...
        t = t.slice(0).sort((e, t) => {
          if (e.range && t.range)
            return Et.compareRangesUsingStarts(e.range, t.range);
          return (e.range ? 0 : 1) - (t.range ? 0 : 1);
        });
        for (let { range: e, text: o, eol: a } of t) {
          if (("number" === typeof a && (i = a), Et.isEmpty(e) && !o)) continue;
          const t = n.getValueInRange(e);
          if (((o = o.replace(/\r\n|\n|\r/g, n.eol)), t === o)) continue;
          if (Math.max(o.length, t.length) > Er._diffLimit) {
            r.push({ range: e, text: o });
            continue;
          }
          const s = Ue(t, o, !1),
            l = n.offsetAt(Et.lift(e).getStartPosition());
          for (const e of s) {
          ...
          if (e)
            for (const n of e.words(o))
              if (
                n !== t &&
                isNaN(Number(n)) &&
                (a.add(n), a.size > Er._suggestionsLimit)
              )
                break e;
        }
    ...
    navigateValueSet(e, t, n, r, i) {
      return Lr(this, void 0, void 0, function* () {
        ...
        return Xt.INSTANCE.navigateValueSet(t, s, l, c, n);
      });
    }
    loadForeignModule(e, t, n) {
      ...
      return this._foreignModuleFactory
        ? ((this._foreignModule = this._foreignModuleFactory(i, t)),
          Promise.resolve(se(this._foreignModule)))
