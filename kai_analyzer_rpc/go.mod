...
require (
	...
	github.com/konveyor/analyzer-lsp v0.6.0-alpha.2.0.20241210150520-4cb468ef1309
	github.com/konveyor/analyzer-lsp/external-providers/java-external-provider v0.0.0-20241210150520-4cb468ef1309
