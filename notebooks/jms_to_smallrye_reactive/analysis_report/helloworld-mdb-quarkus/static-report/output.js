window["apps"] = [
  {
    ...
    rulesets: [
      ...
      },
      {
        ...
        violations: {
          ...
          "jms-to-reactive-quarkus-00010": {
            ...
            incidents: [
              {
                uri: "file:///tmp/source-code/src/main/java/org/jboss/as/quickstarts/mdb/HelloWorldQueueMDB.java",
                message:
              ...
              {
                uri: "file:///tmp/source-code/src/main/java/org/jboss/as/quickstarts/mdb/HelloWorldTopicMDB.java",
                message:
                  "Enterprise Java Beans (EJBs) are not supported in Quarkus. CDI must be used.\n Please replace the `@MessageDriven` annotation with a CDI scope annotation like `@ApplicationScoped`.",
                codeSnip:
      ...
      },
      {
        ...
        tags: ["EJB XML", "Java Source", "Maven XML", "Spring XML"],
        unmatched: [
          "discover-license",
        ...
        dependencies: [
          {
            ...
            type: "provided",
            resolvedIdentifier: "308fcbb4bb61d33dadd8a2b54f4cd8dbe6bc40fb",
            extras: {
          ...
          },
          {
            ...
            version: "2.0.0.Final-redhat-00001",
            type: "provided",
            resolvedIdentifier: "5c2cd61ddb670f128661a8bd31aaac8231e4815d",
            extras: {
