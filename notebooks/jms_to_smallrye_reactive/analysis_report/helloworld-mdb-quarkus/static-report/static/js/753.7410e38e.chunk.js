    ...
    31753: (e, i, t) => {
      ...
      const O = (e, i) => {
          ...
          return Object.keys(t || {}).reduce(
            (i, n) =>
              "default" === n
                ? Object.assign(Object.assign({}, i), { [e]: t[n] })
                : Object.assign(Object.assign({}, i), {
                    ["".concat(e, "-on-").concat(n)]: t[n],
                  }),
            {},
          );
        },
        T = (e) => {
          var {
              ...
              isFluid: c,
              isFillColumns: d,
              displaySize: m = "default",
              columnModifier: p,
              autoFitMinModifier: h,
              termWidth: g,
              horizontalTermWidthModifier: f,
              orientation: u,
              style: x,
            } = e,
            T = (0, C.__rest)(e, [
          ...
          return (
            o &&
              ...
              (x = Object.assign(
                Object.assign({}, x),
                O("--pf-v5-c-description-list--GridTemplateColumns--min", h),
              )),
            g &&
              (x = Object.assign(Object.assign({}, x), {
                "--pf-v5-c-description-list__term--width": g,
              })),
            s &&
              f &&
              (x = Object.assign(
                Object.assign({}, x),
                O("--pf-v5-c-description-list--m-horizontal__term--width", f),
              )),
            n.createElement(
              "dl",
              Object.assign(
                {
                  className: (0, j.i)(
                    v.descriptionList,
                    (s || c) && v.modifiers.horizontal,
                    l && v.modifiers.autoColumnWidths,
                    o && v.modifiers.autoFit,
                    (0, L.wt)(p, v),
                    (0, L.wt)(u, v),
                    a && v.modifiers.inlineGrid,
                    r && v.modifiers.compact,
                    c && v.modifiers.fluid,
                    d && v.modifiers.fillColumns,
                    "lg" === m && v.modifiers.displayLg,
                    "2xl" === m && v.modifiers.display_2xl,
                    i,
                  ),
                  style: x,
                },
      ...
      const y = (e) => {
        var { className: i, children: t } = e,
          s = (0, C.__rest)(e, ["className", "children"]);
        return n.createElement(
          "div",
          Object.assign({ className: (0, j.i)(v.descriptionListGroup, i) }, s),
          t,
        );
      };
      y.displayName = "DescriptionListGroup";
      const _ = (e) => {
        var { children: i, className: t, icon: s } = e,
          l = (0, C.__rest)(e, ["children", "className", "icon"]);
        return n.createElement(
          "dt",
          Object.assign({ className: (0, j.i)(v.descriptionListTerm, t) }, l),
          s
            ? n.createElement(
                "span",
                { className: (0, j.i)(v.descriptionListTermIcon) },
                s,
              )
            : null,
          n.createElement(
            "span",
            { className: (0, j.i)(v.descriptionListText) },
            i,
          ),
        );
      };
      _.displayName = "DescriptionListTerm";
      const b = (e) => {
        var { children: i = null, className: t } = e,
          s = (0, C.__rest)(e, ["children", "className"]);
        return n.createElement(
          "dd",
          Object.assign(
            { className: (0, j.i)(v.descriptionListDescription, t) },
            s,
          ),
          n.createElement(
            "div",
      ...
      b.displayName = "DescriptionListDescription";
      var M = t(39698),
        N = t(39720);
      const z = (0, N.I)({
          name: "TagIcon",
      ...
      var w = t(49384),
        ...
        Z = t(80184),
        B = (function (e) {
          return (e.tags = "tags"), (e.incidents = "incidents"), e;
        })(B || {});
      const H = Object.values(B),
        X = (e, i, t) => (0 === t ? e.name.localeCompare(i.name) : 0),
        R = () => {
          const [e, i] = (0, n.useState)(""),
            ...
            L = (0, G.Le)(),
            O = (0, n.useMemo)(() => {
              const e = (L.data || []).flatMap((e) => e.tagsFlat);
              return Array.from(new Set(e)).sort((e, i) => e.localeCompare(i));
            }, [L.data]),
            N = (0, n.useMemo)(
              () =>
                ((null === L || void 0 === L ? void 0 : L.data) || []).reduce(
                  (e, i) => {
                    const t = i.issues.reduce(
                      (e, i) => (
                        (e[i.category] = e[i.category] || 0),
                        (e[i.category] += i.totalIncidents),
                        e
                      ),
                      {},
                    );
            ...
            { pageItems: V, filteredItems: q } = (0, W.x6)({
              items: L.data || [],
              currentPage: R,
              currentSortBy: U,
              compareToByColumn: X,
              filterItem: (i) => {
                ...
                e &&
                  e.trim().length > 0 &&
                  (n = -1 !== i.name.toLowerCase().indexOf(e.toLowerCase()));
                let s = !0;
                const l = t.get("tag") || [];
                return (
                  l.length > 0 &&
                    (s = l.some((e) =>
                      i.tags.flatMap((e) => e.name).some((i) => e === i),
                    )),
                  n && s
                );
              },
            ...
            {
              isCellSelected: K,
              isSomeCellSelected: Y,
              toggleCellSelected: $,
            } = (0, W.QM)({ rows: V.map((e) => e.id), columns: H });
          return (
            (0, n.useEffect)(() => {
              J({ page: 1, perPage: R.perPage });
            }, [t, J, R.perPage]),
            (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(l.NP, {
                  variant: l.Dk.light,
                  children: (0, Z.jsxs)(o.D, {
                    children: [
                      (0, Z.jsx)(a.x, {
                        component: "h1",
                ...
                (0, Z.jsxs)(l.NP, {
                  variant: l.Dk.default,
                  children: [
                    (0, Z.jsx)(r.o, {
                      className: "pf-m-toggle-group-container",
                      collapseListedFiltersBreakpoint: "xl",
                      clearAllFilters: v,
                      children: (0, Z.jsxs)(c.c, {
                        children: [
                          (0, Z.jsxs)(d.R, {
                            toggleIcon: (0, Z.jsx)(M.ZP, {}),
                            breakpoint: "xl",
                            children: [
                              (0, Z.jsx)(m.E, {
                              ...
                              (0, Z.jsx)(h.k, {
                                ...
                                children: (0, Z.jsx)(g.p, {
                                  chips: t.get("tag"),
                                  deleteChip: (e, i) => j("tag", i),
                                  deleteChipGroup: () => C("tag", []),
                                  categoryName: { key: "tag", name: "Tag" },
                                  children: (0, Z.jsx)(A.GU, {
                                    width: 250,
                                    maxHeight: 300,
                                    toggleIcon: (0, Z.jsx)(M.ZP, {}),
                                    variant: "checkbox",
                          ...
                          (0, Z.jsx)(m.E, {
                            variant: m.A.pagination,
                            align: { default: "alignRight" },
                            children: (0, Z.jsx)(A.pb, {
                              count: q.length,
                              params: R,
                              onChange: J,
                              isTop: !0,
                        ...
                        (0, Z.jsx)(F.h, {
                          children: (0, Z.jsxs)(S.Tr, {
                            children: [
                              ...
                              (0, Z.jsx)(E.Th, { width: 10, children: "Tags" }),
                              (0, Z.jsx)(E.Th, {
                                width: 10,
                                children: "Incidents",
                              }),
                                    ...
                                    k.p,
                                    {
                                      ...
                                      children: [
                                        (0, Z.jsxs)(S.Tr, {
                                          children: [
                                            (0, Z.jsx)(P.Td, {
                                              children: (0, Z.jsx)(s.rU, {
                                                to: "/applications/".concat(
                                                  e.id,
                                                ),
                                                children: e.name,
                                              }),
...
//# sourceMappingURL=753.7410e38e.chunk.js.map
