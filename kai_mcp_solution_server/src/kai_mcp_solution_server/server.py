    ...
    async with kai_ctx.session_maker.begin() as session:
        ...
        for solution in solutions:
            prompt = (
                ...
                "Generate a hint for the user so that they can migrate the the code.\n\n"
                "IMPORTANT: Follow this EXACT output format:\n"
                "---\n"
                "SUMMARY:\n"
                "[summary of necessary changes]\n\n"
                "HINT:\n"
                "[actionable hint for future similar migrations with code examples/snippets where applicable]\n"
                "---\n\n"
                "Provide concrete examples and code snippets in your HINT section to make it actionable.\n"
                "Include generalized before/after code examples when relevant.\n\n"
                "Incidents:\n"
            )
