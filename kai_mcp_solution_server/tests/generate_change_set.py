...
async def main() -> None:
    """
    Creates and prints a solution change set representing the migration of a Java JMS message-driven bean to a Quarkus reactive messaging consumer.
    
    The change set includes the full diff and before/after file contents for the refactored Java class, demonstrating the transition from legacy JMS-based message handling to a modern, reactive, and transactional approach using Quarkus and MicroProfile Reactive Messaging.
    """
    s = SolutionChangeSet(
        diff="""\
